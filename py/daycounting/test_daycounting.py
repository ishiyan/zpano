...
class TestEur30360Model2(unittest.TestCase):
    ...
    def test_excel_basis_4(self):
        ...
        self.assertEqual(round(eur_30_360_model_2(2020, 2, 21, 2024, 3, 25), 13),
            round(4.0944444444444400, 13), '2020-02-21 -> 2024-03-25')
        self.assertEqual(round(eur_30_360_model_2(2020, 2, 29, 2021, 2, 28), 2), # Error: 1.0 != 0.9972222222222
            round(0.9972222222222220, 2), '2020-02-29 -> 2021-02-28')
        self.assertEqual(round(eur_30_360_model_2(2020, 1, 31, 2021, 2, 28), 1), # Error: 1.0833333333333 != 1.0777777777778
            round(1.0777777777777800, 1), '2020-01-31 -> 2021-02-28')
        ...
        self.assertEqual(round(eur_30_360_model_2(2018, 2, 5, 2023, 5, 14), 13),
            round(5.2750000000000000, 13), '2018-02-05 -> 2023-05-14')
        self.assertEqual(round(eur_30_360_model_2(2020, 2, 29, 2024, 2, 28), 2), # Error: 4.0 != 3.9972222222222
            round(3.9972222222222200, 2), '2020-02-29 -> 2024-02-28')
        ...
        self.assertEqual(round(eur_30_360_model_2(2023, 1, 1, 2023, 3, 1), 13),
            round(0.1666666666666670, 13), '2023-01-01 -> 2023-03-01')
        self.assertEqual(round(eur_30_360_model_2(2024, 2, 29, 2025, 2, 28), 2), # Error: 1.0 != 0.9972222222222
            round(0.9972222222222220, 2), '2024-02-29 -> 2025-02-28')
        ...
        self.assertEqual(round(eur_30_360_model_2(2024, 2, 29, 2025, 3, 1), 13),
            round(1.0055555555555600, 13), '2024-02-29 -> 2025-03-01')
        self.assertEqual(round(eur_30_360_model_2(2024, 2, 29, 2028, 2, 28), 2), # Error: 4.0 != 3.9972222222222
            round(3.9972222222222200, 2), '2024-02-29 -> 2028-02-28')
...
class TestEur30360Model3(unittest.TestCase):
    ...
    def test_time(self):
        ...
        self.assertEqual(round(eur_30_360_model_3(
            ...
            round(FD2_360, 13))
    def test_excel_basis_4(self):
        self.assertEqual(round(eur_30_360_model_3(1978, 2, 28, 2020, 5, 17), 1), # Error: 42.2138888888889 != 42.2194444444444
            round(42.2194444444444000, 1), '1978-02-28 -> 2020-05-17')
        ...
        self.assertEqual(round(eur_30_360_model_3(2020, 2, 21, 2024, 3, 25), 13),
            round(4.0944444444444400, 13), '2020-02-21 -> 2024-03-25')
        self.assertEqual(round(eur_30_360_model_3(2020, 2, 29, 2021, 2, 28), 2), # Error: 1.0 != 0.9972222222222
            round(0.9972222222222220, 2), '2020-02-29 -> 2021-02-28')
        self.assertEqual(round(eur_30_360_model_3(2020, 1, 31, 2021, 2, 28), 1), # Error: 1.0833333333333 != 1.0777777777778
            round(1.0777777777777800, 1), '2020-01-31 -> 2021-02-28')
        ...
        self.assertEqual(round(eur_30_360_model_3(2018, 2, 5, 2023, 5, 14), 13),
            round(5.2750000000000000, 13), '2018-02-05 -> 2023-05-14')
        self.assertEqual(round(eur_30_360_model_3(2020, 2, 29, 2024, 2, 28), 2), # Error: 4.0 != 3.9972222222222
            round(3.9972222222222200, 2), '2020-02-29 -> 2024-02-28')
        self.assertEqual(round(eur_30_360_model_3(2010, 3, 31, 2015, 8, 30), 13),
            round(5.4166666666666700, 13), '2010-03-31 -> 2015-08-30')
        self.assertEqual(round(eur_30_360_model_3(2016, 2, 28, 2016, 10, 30), 1), # Error: 0.6666666666667 != 0.6722222222222
            round(0.6722222222222220, 1), '2016-02-28 -> 2016-10-30')
        self.assertEqual(round(eur_30_360_model_3(2014, 1, 31, 2014, 8, 31), 13),
            round(0.5833333333333330, 13), '2014-01-31 -> 2014-08-31')
        self.assertEqual(round(eur_30_360_model_3(2014, 2, 28, 2014, 9, 30), 1), # Error: 0.5833333333333 != 0.5888888888889
            round(0.5888888888888890, 1), '2014-02-28 -> 2014-09-30')
        self.assertEqual(round(eur_30_360_model_3(2016, 2, 29, 2016, 6, 15), 2), # Error: 0.2916666666667 != 0.2944444444444
            round(0.2944444444444440, 2), '2016-02-29 -> 2016-06-15')
        ...
        self.assertEqual(round(eur_30_360_model_3(2024, 1, 1, 2025, 1, 2), 13),
            round(1.0027777777777800, 13), '2024-01-01 -> 2025-01-02')
        self.assertEqual(round(eur_30_360_model_3(2024, 1, 1, 2024, 2, 29), 2), # Error: 0.1638888888889 != 0.1611111111111
            round(0.1611111111111110, 2), '2024-01-01 -> 2024-02-29')
        ...
        self.assertEqual(round(eur_30_360_model_3(2023, 1, 1, 2023, 3, 1), 13),
            round(0.1666666666666670, 13), '2023-01-01 -> 2023-03-01')
        self.assertEqual(round(eur_30_360_model_3(2024, 2, 29, 2025, 2, 28), 2), # Error: 1.0 != 0.9972222222222
            round(0.9972222222222220, 2), '2024-02-29 -> 2025-02-28')
        ...
        self.assertEqual(round(eur_30_360_model_3(2024, 3, 1, 2025, 3, 1), 13),
            round(1.0000000000000000, 13), '2024-03-01 -> 2025-03-01')
        self.assertEqual(round(eur_30_360_model_3(2024, 2, 29, 2025, 3, 1), 1), # Error: 1.0027777777778 != 1.0055555555556
            round(1.0055555555555600, 1), '2024-02-29 -> 2025-03-01')
        self.assertEqual(round(eur_30_360_model_3(2024, 2, 29, 2028, 2, 28), 2), # Error: 4.0 != 3.9972222222222
            round(3.9972222222222200, 2), '2024-02-29 -> 2028-02-28')
...
class TestEur30360Plus(unittest.TestCase):
    ...
    def test_excel_basis_4(self):
        ...
        self.assertEqual(round(eur_30_360_plus(2020, 1, 31, 2021, 2, 28), 13),
            round(1.0777777777777800, 13), '2020-01-31 -> 2021-02-28')
        self.assertEqual(round(eur_30_360_plus(2020, 1, 31, 2021, 3, 31), 1), # Error: 1.1722222222222 != 1.1666666666667
            round(1.1666666666666700, 1), '2020-01-31 -> 2021-03-31')
        ...
        self.assertEqual(round(eur_30_360_plus(2016, 2, 28, 2016, 10, 30), 13),
            round(0.6722222222222220, 13), '2016-02-28 -> 2016-10-30')
        self.assertEqual(round(eur_30_360_plus(2014, 1, 31, 2014, 8, 31), 1), # Error: 0.5888888888889 != 0.5833333333333
            round(0.5833333333333330, 1), '2014-01-31 -> 2014-08-31')
        ...
        self.assertEqual(round(eur_30_360_plus(2016, 2, 29, 2016, 6, 15), 13),
            round(0.2944444444444440, 13), '2016-02-29 -> 2016-06-15')
        self.assertEqual(round(eur_30_360_plus(2024, 1, 1, 2024, 12, 31), 1), # Error: 1.0027777777778 != 0.9972222222222
            round(0.9972222222222220, 1), '2024-01-01 -> 2024-12-31')
        ...
        self.assertEqual(round(eur_30_360_plus(2024, 2, 29, 2025, 2, 28), 13),
            round(0.9972222222222220, 13), '2024-02-29 -> 2025-02-28')
        self.assertEqual(round(eur_30_360_plus(2024, 1, 1, 2028, 12, 31), 1), # Error: 5.0027777777778 != 4.9972222222222
            round(4.9972222222222200, 1), '2024-01-01 -> 2028-12-31')
...
class TestUs30360(unittest.TestCase):
    ...
    def test_excel_basis_0(self):
        self.assertEqual(round(us_30_360(1978, 2, 28, 2020, 5, 17), 1), # Error: 42.2194444444444 != 42.2138888888889
            round(42.2138888888889000, 1), '1978-02-28 -> 2020-05-17')
        ...
        self.assertEqual(round(us_30_360(2020, 2, 21, 2024, 3, 25), 13),
            round(4.0944444444444400, 13), '2020-02-21 -> 2024-03-25')
        self.assertEqual(round(us_30_360(2020, 2, 29, 2021, 2, 28), 2), # Error: 0.9972222222222 != 1.0
            round(1.0000000000000000, 2), '2020-02-29 -> 2021-02-28')
        ...
        self.assertEqual(round(us_30_360(2018, 2, 5, 2023, 5, 14), 13),
            round(5.2750000000000000, 13), '2018-02-05 -> 2023-05-14')
        self.assertEqual(round(us_30_360(2020, 2, 29, 2024, 2, 28), 1), # Error: 3.9972222222222 != 3.9944444444444
            round(3.9944444444444400, 1), '2020-02-29 -> 2024-02-28')
        ...
        self.assertEqual(round(us_30_360(2014, 1, 31, 2014, 8, 31), 13),
            round(0.5833333333333330, 13), '2014-01-31 -> 2014-08-31')
        self.assertEqual(round(us_30_360(2014, 2, 28, 2014, 9, 30), 1), # Error: 0.5888888888889 != 0.5833333333333
            round(0.5833333333333330, 1), '2014-02-28 -> 2014-09-30')
        self.assertEqual(round(us_30_360(2016, 2, 29, 2016, 6, 15), 2), # Error: 0.2944444444444 != 0.2916666666667
            round(0.2916666666666670, 2), '2016-02-29 -> 2016-06-15')
        ...
        self.assertEqual(round(us_30_360(2023, 1, 1, 2023, 3, 1), 13),
            round(0.1666666666666670, 13), '2023-01-01 -> 2023-03-01')
        self.assertEqual(round(us_30_360(2024, 2, 29, 2025, 2, 28), 2), # Error: 0.9972222222222 != 1.0
            round(1.0000000000000000, 2), '2024-02-29 -> 2025-02-28')
        ...
        self.assertEqual(round(us_30_360(2024, 3, 1, 2025, 3, 1), 13),
            round(1.0000000000000000, 13), '2024-03-01 -> 2025-03-01')
        self.assertEqual(round(us_30_360(2024, 2, 29, 2025, 3, 1), 1), # Error: 1.0055555555556 != 1.0027777777778
            round(1.0027777777777800, 1), '2024-02-29 -> 2025-03-01')
        self.assertEqual(round(us_30_360(2024, 2, 29, 2028, 2, 28), 1), # Error: 3.9972222222222 != 3.9944444444444
            round(3.9944444444444400, 1), '2024-02-29 -> 2028-02-28')
...
class TestUs30360Eom(unittest.TestCase):
    ...
    def test_excel_basis_0(self):
        ...
        self.assertEqual(round(us_30_360_eom(2018, 2, 5, 2023, 5, 14), 13),
            round(5.2750000000000000, 13), '2018-02-05 -> 2023-05-14')
        self.assertEqual(round(us_30_360_eom(2020, 2, 29, 2024, 2, 28), 1), # Error: 4.0 != 3.9944444444444
            round(3.9944444444444400, 1), '2020-02-29 -> 2024-02-28')
        self.assertEqual(round(us_30_360_eom(2010, 3, 31, 2015, 8, 30), 13),
            round(5.4166666666666700, 13), '2010-03-31 -> 2015-08-30')
        self.assertEqual(round(us_30_360_eom(2016, 2, 28, 2016, 10, 30), 1), # Error: 0.6666666666667 != 0.6722222222222
            round(0.6722222222222220, 1), '2016-02-28 -> 2016-10-30')
        ...
        self.assertEqual(round(us_30_360_eom(2024, 2, 29, 2028, 2, 28), 1), # Error: 4.0 != 3.9944444444444
            round(3.9944444444444400, 1), '2024-02-29 -> 2028-02-28')
...
class TestUs30360Nasd(unittest.TestCase):
    ...
    def test_yearfrac_0(self):
        ...
        self.assertEqual(round(x, 8), 0.58055556)
    def test_excel_basis_0(self):
        self.assertEqual(round(us_30_360_nasd(1978, 2, 28, 2020, 5, 17), 1), # Error: 42.2194444444444 != 42.2138888888889
            round(42.2138888888889000, 1), '1978-02-28 -> 2020-05-17')
        ...
        self.assertEqual(round(us_30_360_nasd(2020, 2, 21, 2024, 3, 25), 13),
            round(4.0944444444444400, 13), '2020-02-21 -> 2024-03-25')
        self.assertEqual(round(us_30_360_nasd(2020, 2, 29, 2021, 2, 28), 2), # Error: 0.9972222222222 != 1.0
            round(1.0000000000000000, 2), '2020-02-29 -> 2021-02-28')
        ...
        self.assertEqual(round(us_30_360_nasd(2018, 2, 5, 2023, 5, 14), 13),
            round(5.2750000000000000, 13), '2018-02-05 -> 2023-05-14')
        self.assertEqual(round(us_30_360_nasd(2020, 2, 29, 2024, 2, 28), 1), # Error: 3.9972222222222 != 3.9944444444444
            round(3.9944444444444400, 1), '2020-02-29 -> 2024-02-28')
        ...
        self.assertEqual(round(us_30_360_eom(2014, 2, 28, 2014, 9, 30), 13),
            round(0.5833333333333330, 13), '2014-02-28 -> 2014-09-30')
        self.assertEqual(round(us_30_360_nasd(2016, 2, 29, 2016, 6, 15), 2), # Error: 0.2944444444444 != 0.2916666666667
            round(0.2916666666666670, 2), '2016-02-29 -> 2016-06-15')
        self.assertEqual(round(us_30_360_nasd(2024, 1, 1, 2024, 12, 31), 2), # Error: 1.0027777777778 != 1.0
            round(1.0000000000000000, 2), '2024-01-01 -> 2024-12-31')
        ...
        self.assertEqual(round(us_30_360_nasd(2023, 1, 1, 2023, 3, 1), 13),
            round(0.1666666666666670, 13), '2023-01-01 -> 2023-03-01')
        self.assertEqual(round(us_30_360_nasd(2024, 2, 29, 2025, 2, 28), 2), # Error: 0.9972222222222 != 1.0
            round(1.0000000000000000, 2), '2024-02-29 -> 2025-02-28')
        self.assertEqual(round(us_30_360_nasd(2024, 1, 1, 2028, 12, 31), 2), # Error: 5.0027777777778 != 5.0
            round(5.0000000000000000, 2), '2024-01-01 -> 2028-12-31')
        self.assertEqual(round(us_30_360_nasd(2024, 3, 1, 2025, 3, 1), 13),
            round(1.0000000000000000, 13), '2024-03-01 -> 2025-03-01')
        self.assertEqual(round(us_30_360_nasd(2024, 2, 29, 2025, 3, 1), 1), # Error: 1.0055555555556 != 1.0027777777778
            round(1.0027777777777800, 1), '2024-02-29 -> 2025-03-01')
        self.assertEqual(round(us_30_360_nasd(2024, 2, 29, 2028, 2, 28), 1), # Error: 3.9972222222222 != 3.9944444444444
            round(3.9944444444444400, 1), '2024-02-29 -> 2028-02-28')
...
class TestAct365NonLeap(unittest.TestCase):
    ...
    def test_excel_basis_3(self):
        self.assertEqual(round(act_365_nonleap(1978, 2, 28, 2020, 5, 17), 1), # Error: 42.213698630137 != 42.2438356164384
            round(42.2438356164384, 1), '1978-02-28 -> 2020-05-17')
        self.assertEqual(round(act_365_nonleap(1993, 12, 2, 2022, 4, 18), 1), # Error: 28.3753424657534 != 28.3945205479452
            round(28.3945205479452, 1), '1993-12-02 -> 2022-04-18')
        ...
        self.assertEqual(round(act_365_nonleap(1994, 6, 30, 1997, 6, 30), 2), # Error: 3.0 != 3.0027397260274
            round(3.002739726027400, 2), '1994-06-30 -> 1997-06-30')
        self.assertEqual(round(act_365_nonleap(1994, 2, 10, 1994, 6, 30), 13),
            round(0.383561643835616, 13), '1994-02-10 -> 1994-06-30')
        self.assertEqual(round(act_365_nonleap(2020, 2, 21, 2024, 3, 25), 2), # Error: 4.0876712328767 != 4.0931506849315
            round(4.093150684931510, 2), '2020-02-21 -> 2024-03-25')
        self.assertEqual(round(act_365_nonleap(2020, 2, 29, 2021, 2, 28), 2), # Error: 0.9972602739726 != 1.0
            round(1.000000000000000, 2), '2020-02-29 -> 2021-02-28')
        self.assertEqual(round(act_365_nonleap(2020, 1, 31, 2021, 2, 28), 2), # Error: 1.0767123287671 != 1.0794520547945
            round(1.079452054794520, 2), '2020-01-31 -> 2021-02-28')
        self.assertEqual(round(act_365_nonleap(2020, 1, 31, 2021, 3, 31), 2), # Error: 1.1616438356164 != 1.1643835616438
            round(1.164383561643840, 2), '2020-01-31 -> 2021-03-31')
        self.assertEqual(round(act_365_nonleap(2020, 1, 31, 2020, 4, 30), 1), # Error: 0.2438356164384 != 0.2465753424658
            round(0.246575342465753, 1), '2020-01-31 -> 2020-04-30')
        self.assertEqual(round(act_365_nonleap(2018, 2, 5, 2023, 5, 14), 2), # Error: 5.2684931506849 != 5.2712328767123
            round(5.271232876712330, 2), '2018-02-05 -> 2023-05-14')
        self.assertEqual(round(act_365_nonleap(2020, 2, 29, 2024, 2, 28), 2), # Error: 3.9972602739726 != 4.0
            round(4.000000000000000, 2), '2020-02-29 -> 2024-02-28')
        self.assertEqual(round(act_365_nonleap(2010, 3, 31, 2015, 8, 30), 2), # Error: 5.4164383561644 != 5.4191780821918
            round(5.419178082191780, 2), '2010-03-31 -> 2015-08-30')
        self.assertEqual(round(act_365_nonleap(2016, 2, 28, 2016, 10, 30), 2), # Error: 0.6684931506849 != 0.6712328767123
            round(0.671232876712329, 2), '2016-02-28 -> 2016-10-30')
        ...
        self.assertEqual(round(act_365_nonleap(2016, 2, 29, 2016, 6, 15), 2), # Error: 0.2904109589041 != 0.2931506849315
            round(0.293150684931507, 2), '2016-02-29 -> 2016-06-15')
        self.assertEqual(round(act_365_nonleap(2024, 1, 1, 2024, 12, 31), 2), # Error: 0.9972602739726 != 1.0
            round(1.000000000000000, 2), '2024-01-01 -> 2024-12-31')
        self.assertEqual(round(act_365_nonleap(2024, 1, 1, 2025, 1, 2), 1), # Error: 1.0027397260274 != 1.0054794520548
            round(1.005479452054790, 1), '2024-01-01 -> 2025-01-02')
        self.assertEqual(round(act_365_nonleap(2024, 1, 1, 2024, 2, 29), 2), # Error: 0.158904109589 != 0.1616438356164
            round(0.161643835616438, 2), '2024-01-01 -> 2024-02-29')
        self.assertEqual(round(act_365_nonleap(2024, 1, 1, 2024, 3, 1), 2), # Error: 0.1616438356164 != 0.1643835616438
            round(0.164383561643836, 2), '2024-01-01 -> 2024-03-01')
        self.assertEqual(round(act_365_nonleap(2023, 1, 1, 2023, 3, 1), 13),
            round(0.161643835616438, 13), '2023-01-01 -> 2023-03-01')
        self.assertEqual(round(act_365_nonleap(2024, 2, 29, 2025, 2, 28), 2), # Error: 0.9972602739726 != 1.0
            round(1.000000000000000, 2), '2024-02-29 -> 2025-02-28')
        self.assertEqual(round(act_365_nonleap(2024, 1, 1, 2028, 12, 31), 2), # Error: 4.9972602739726 != 5.0027397260274
            round(5.002739726027400, 2), '2024-01-01 -> 2028-12-31')
        self.assertEqual(round(act_365_nonleap(2024, 3, 1, 2025, 3, 1), 13),
            round(1.000000000000000, 13), '2024-03-01 -> 2025-03-01')
        self.assertEqual(round(act_365_nonleap(2024, 2, 29, 2025, 3, 1), 2), # Error: 1.0 != 1.0027397260274
            round(1.002739726027400, 2), '2024-02-29 -> 2025-03-01')
        self.assertEqual(round(act_365_nonleap(2024, 2, 29, 2028, 2, 28), 2), # Error: 3.9972602739726 != 4.0
            round(4.000000000000000, 2), '2024-02-29 -> 2028-02-28')
        self.assertEqual(round(act_365_nonleap(2024, 2, 29, 2028, 2, 29), 2), # Error: 4.0 != 4.0027397260274
            round(4.002739726027400, 2), '2024-02-29 -> 2028-02-29')
        self.assertEqual(round(act_365_nonleap(2024, 3, 1, 2028, 3, 1), 2), # Error: 4.0 != 4.0027397260274
            round(4.002739726027400, 2), '2024-03-01 -> 2028-03-01')
...
class TestActActIsda(unittest.TestCase):
    ...
    def test_yearfrac_1(self):
        ...
        self.assertEqual(round(x, 8), 0.57650273)
    def test_excel_basis_1(self):
        self.assertEqual(round(act_act_isda(1978, 2, 28, 2020, 5, 17), 2), # Error: 42.2126731042743 != 42.2142493314657
            round(42.214249331465700000, 2), '1978-02-28 -> 2020-05-17')
        self.assertEqual(round(act_act_isda(1993, 12, 2, 2022, 4, 18), 1), # Error: 28.372602739726 != 28.3763803960938
            round(28.376380396093800000, 1), '1993-12-02 -> 2022-04-18')
        self.assertEqual(round(act_act_isda(2018, 12, 15, 2019, 3, 1), 2), # Error: 0.2054794520548 != 0.2082191780822
            round(0.208219178082192000, 2), '2018-12-15 -> 2019-03-01')
        self.assertEqual(round(act_act_isda(2018, 12, 31, 2019, 1, 1), 2), # Error: 0.0 != 0.0027397260274
            round(0.002739726027397260, 2), '2018-12-31 -> 2019-01-01')
        self.assertEqual(round(act_act_isda(1994, 6, 30, 1997, 6, 30), 2), # Error: 2.9972602739726 != 3.0006844626968
            round(3.000684462696780000, 2), '1994-06-30 -> 1997-06-30')
        self.assertEqual(round(act_act_isda(1994, 2, 10, 1994, 6, 30), 13),
            round(0.383561643835616000, 13), '1994-02-10 -> 1994-06-30')
        self.assertEqual(round(act_act_isda(2020, 2, 21, 2024, 3, 25), 2), # Error: 4.0874316939891 != 4.0886699507389
            round(4.088669950738920000, 2), '2020-02-21 -> 2024-03-25')
        self.assertEqual(round(act_act_isda(2020, 2, 29, 2021, 2, 28), 1), # Error: 0.9949696833595 != 0.9972677595628
            round(0.997267759562842000, 1), '2020-02-29 -> 2021-02-28')
        self.assertEqual(round(act_act_isda(2020, 1, 31, 2021, 2, 28), 1), # Error: 1.0742046560371 != 1.077975376197
            round(1.077975376196990000, 1), '2020-01-31 -> 2021-02-28')
        self.assertEqual(round(act_act_isda(2020, 1, 31, 2021, 3, 31), 2), # Error: 1.1591361628864 != 1.1627906976744
            round(1.162790697674420000, 2), '2020-01-31 -> 2021-03-31')
        self.assertEqual(round(act_act_isda(2020, 1, 31, 2020, 4, 30), 13),
            round(0.245901639344262000, 13), '2020-01-31 -> 2020-04-30')
        self.assertEqual(round(act_act_isda(2018, 2, 5, 2023, 5, 14), 2), # Error: 5.2657534246575 != 5.2688270196257
            round(5.268827019625740000, 2), '2018-02-05 -> 2023-05-14')
        self.assertEqual(round(act_act_isda(2020, 2, 29, 2024, 2, 28), 1), # Error: 3.9945355191257 != 3.9956212370006
            round(3.995621237000550000, 1), '2020-02-29 -> 2024-02-28')
        self.assertEqual(round(act_act_isda(2010, 3, 31, 2015, 8, 30), 1), # Error: 5.413698630137 != 5.4167047010497
            round(5.416704701049750000, 1), '2010-03-31 -> 2015-08-30')
        self.assertEqual(round(act_act_excel(2016, 2, 28, 2016, 10, 30), 13),
            round(0.669398907103825000, 13), '2016-02-28 -> 2016-10-30')
        ...
        self.assertEqual(round(act_act_isda(2024, 1, 1, 2024, 12, 31), 13),
            round(0.997267759562842000, 13), '2024-01-01 -> 2024-12-31')
        self.assertEqual(round(act_act_isda(2024, 1, 1, 2025, 1, 2), 2), # Error: 1.0000074855902 != 1.0041039671683
            round(1.004103967168260000, 2), '2024-01-01 -> 2025-01-02')
        ...
        self.assertEqual(round(act_act_excel(2023, 1, 1, 2023, 3, 1), 13),
            round(0.161643835616438000, 13), '2023-01-01 -> 2023-03-01')
        self.assertEqual(round(act_act_isda(2024, 2, 29, 2025, 2, 28), 1), # Error: 0.9949696833595 != 0.9972677595628
            round(0.997267759562842000, 1), '2024-02-29 -> 2025-02-28')
        self.assertEqual(round(act_act_isda(2024, 1, 1, 2028, 12, 31), 1), # Error: 4.9945355191257 != 4.9972632731253
            round(4.997263273125340000, 1), '2024-01-01 -> 2028-12-31')
        self.assertEqual(round(act_act_isda(2024, 3, 1, 2025, 3, 1), 1), # Error: 0.9949771689498 != 1.0
            round(1.000000000000000000, 1), '2024-03-01 -> 2025-03-01')
        self.assertEqual(round(act_act_isda(2024, 2, 29, 2025, 3, 1), 2), # Error: 0.9977094093869 != 1.0013679890561
            round(1.001367989056090000, 2), '2024-02-29 -> 2025-03-01')
        self.assertEqual(round(act_act_isda(2024, 2, 29, 2028, 2, 28), 1), # Error: 3.9945355191257 != 3.9956212370006
            round(3.995621237000550000, 1), '2024-02-29 -> 2028-02-28')
        self.assertEqual(round(act_act_isda(2024, 2, 29, 2028, 2, 29), 2), # Error: 3.9972677595628 != 3.9983579638752
            round(3.998357963875210000, 2), '2024-02-29 -> 2028-02-29')
        self.assertEqual(round(act_act_isda(2024, 3, 1, 2028, 3, 1), 2), # Error: 3.9972677595628 != 3.9983579638752
            round(3.998357963875210000, 2), '2024-03-01 -> 2028-03-01')
...
class TestActActAfb(unittest.TestCase):
    ...
    def test_yearfrac_1(self):
        ...
        self.assertEqual(round(x, 8), 0.57650273)
    def test_excel_basis_1(self):
        self.assertEqual(round(act_act_afb(1978, 2, 28, 2020, 5, 17), 2), # Error: 42.2126731042743 != 42.2142493314657
            round(42.214249331465700000, 2), '1978-02-28 -> 2020-05-17')
        self.assertEqual(round(act_act_afb(1993, 12, 2, 2022, 4, 18), 1), # Error: 28.372602739726 != 28.3763803960938
            round(28.376380396093800000, 1), '1993-12-02 -> 2022-04-18')
        self.assertEqual(round(act_act_afb(2018, 12, 15, 2019, 3, 1), 2), # Error: 0.2054794520548 != 0.2082191780822
            round(0.208219178082192000, 2), '2018-12-15 -> 2019-03-01')
        self.assertEqual(round(act_act_afb(2018, 12, 31, 2019, 1, 1), 2), # Error: 0.0 != 0.0027397260274
            round(0.002739726027397260, 2), '2018-12-31 -> 2019-01-01')
        self.assertEqual(round(act_act_afb(1994, 6, 30, 1997, 6, 30), 2), # Error: 2.9972602739726 != 3.0006844626968
            round(3.000684462696780000, 2), '1994-06-30 -> 1997-06-30')
        self.assertEqual(round(act_act_afb(1994, 2, 10, 1994, 6, 30), 13),
            round(0.383561643835616000, 13), '1994-02-10 -> 1994-06-30')
        self.assertEqual(round(act_act_afb(2020, 2, 21, 2024, 3, 25), 2), # Error: 4.0874316939891 != 4.0886699507389
            round(4.088669950738920000, 2), '2020-02-21 -> 2024-03-25')
        self.assertEqual(round(act_act_afb(2020, 2, 29, 2021, 2, 28), 1), # Error: 0.9949696833595 != 0.9972677595628
            round(0.997267759562842000, 1), '2020-02-29 -> 2021-02-28')
        self.assertEqual(round(act_act_afb(2020, 1, 31, 2021, 2, 28), 1), # Error: 1.0742046560371 != 1.077975376197
            round(1.077975376196990000, 1), '2020-01-31 -> 2021-02-28')
        self.assertEqual(round(act_act_afb(2020, 1, 31, 2021, 3, 31), 2), # Error: 1.1591361628864 != 1.1627906976744
            round(1.162790697674420000, 2), '2020-01-31 -> 2021-03-31')
        self.assertEqual(round(act_act_afb(2020, 1, 31, 2020, 4, 30), 13),
            round(0.245901639344262000, 13), '2020-01-31 -> 2020-04-30')
        self.assertEqual(round(act_act_afb(2018, 2, 5, 2023, 5, 14), 2), # Error: 5.2657534246575 != 5.2688270196257
            round(5.268827019625740000, 2), '2018-02-05 -> 2023-05-14')
        self.assertEqual(round(act_act_afb(2020, 2, 29, 2024, 2, 28), 1), # Error: 3.9949696833595 != 3.9956212370006
            round(3.995621237000550000, 1), '2020-02-29 -> 2024-02-28')
        self.assertEqual(round(act_act_afb(2010, 3, 31, 2015, 8, 30), 1), # Error: 5.413698630137 != 5.4167047010497
            round(5.416704701049750000, 1), '2010-03-31 -> 2015-08-30')
        ...
        self.assertEqual(round(act_act_afb(2024, 1, 1, 2024, 12, 31), 13),
            round(0.997267759562842000, 13), '2024-01-01 -> 2024-12-31')
        self.assertEqual(round(act_act_afb(2024, 1, 1, 2025, 1, 2), 2), # Error: 1.0000074855902 != 1.0041039671683
            round(1.004103967168260000, 2), '2024-01-01 -> 2025-01-02')
        ...
        self.assertEqual(round(act_act_afb(2023, 1, 1, 2023, 3, 1), 13),
            round(0.161643835616438000, 13), '2023-01-01 -> 2023-03-01')
        self.assertEqual(round(act_act_afb(2024, 2, 29, 2025, 2, 28), 1), # Error: 0.9949696833595 != 0.9972677595628
            round(0.997267759562842000, 1), '2024-02-29 -> 2025-02-28')
        self.assertEqual(round(act_act_afb(2024, 1, 1, 2028, 12, 31), 1), # Error: 4.9945355191257 != 4.9972632731253
            round(4.997263273125340000, 1), '2024-01-01 -> 2028-12-31')
        self.assertEqual(round(act_act_afb(2024, 3, 1, 2025, 3, 1), 2), # Error: 0.9972602739726 != 1.0
            round(1.000000000000000000, 2), '2024-03-01 -> 2025-03-01')
        self.assertEqual(round(act_act_afb(2024, 2, 29, 2025, 3, 1), 2), # Error: 0.9977094093869 != 1.0013679890561
            round(1.001367989056090000, 2), '2024-02-29 -> 2025-03-01')
        self.assertEqual(round(act_act_afb(2024, 2, 29, 2028, 2, 28), 1), # Error: 3.9949696833595 != 3.9956212370006
            round(3.995621237000550000, 1), '2024-02-29 -> 2028-02-28')
        self.assertEqual(round(act_act_afb(2024, 2, 29, 2028, 2, 29), 2), # Error: 3.9977094093869 != 3.9983579638752
            round(3.998357963875210000, 2), '2024-02-29 -> 2028-02-29')
        self.assertEqual(round(act_act_afb(2024, 3, 1, 2028, 3, 1), 2), # Error: 3.9995508645857 != 3.9983579638752
            round(3.998357963875210000, 2), '2024-03-01 -> 2028-03-01')
