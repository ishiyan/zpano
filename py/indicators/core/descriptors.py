...
_descriptors: dict[Id, Descriptor] = {
    ...
    Id.FRACTAL_DIMENSION_INDEX: _d(
        Id.FRACTAL_DIMENSION_INDEX, "Jean-Philippe Poton", A.STATIC, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.OSCILLATOR, P.OWN)]),
    Id.FRACTAL_GRAPH_DIMENSION_INDEX: _d(
        Id.FRACTAL_GRAPH_DIMENSION_INDEX, "Jean-Philippe Poton", A.STATIC, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.OSCILLATOR, P.OWN),
         _o(1, S.SCALAR, R.OSCILLATOR, P.OWN),
         _o(2, S.SCALAR, R.OSCILLATOR, P.OWN),
         _o(3, S.SCALAR, R.OSCILLATOR, P.OWN),
         _o(4, S.BAND, R.ENVELOPE, P.OWN)]),
    Id.FRACTAL_ADAPTIVE_SIMPLE_MOVING_AVERAGE: _d(
        Id.FRACTAL_ADAPTIVE_SIMPLE_MOVING_AVERAGE, "Jean-Philippe Poton", A.ADAPTIVE, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE)]),
    Id.FRACTAL_ADAPTIVE_SIMPLE_MOVING_AVERAGE_2: _d(
        Id.FRACTAL_ADAPTIVE_SIMPLE_MOVING_AVERAGE_2, "Jean-Philippe Poton", A.ADAPTIVE, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE)]),
    Id.RESCALED_FRACTAL_ADAPTIVE_SIMPLE_MOVING_AVERAGE: _d(
        Id.RESCALED_FRACTAL_ADAPTIVE_SIMPLE_MOVING_AVERAGE, "Jean-Philippe Poton", A.ADAPTIVE, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE)]),
    Id.FRACTAL_BANDS: _d(
        Id.FRACTAL_BANDS, "Jean-Philippe Poton", A.ADAPTIVE, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE),
         _o(1, S.SCALAR, R.ENVELOPE, P.PRICE),
         _o(2, S.SCALAR, R.ENVELOPE, P.PRICE),
         _o(3, S.BAND, R.ENVELOPE, P.PRICE)]),
    Id.FRACTAL_BANDS_HYBRIDE_ADAPTIVE: _d(
        Id.FRACTAL_BANDS_HYBRIDE_ADAPTIVE, "Jean-Philippe Poton", A.ADAPTIVE, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE),
         _o(1, S.SCALAR, R.ENVELOPE, P.PRICE),
         _o(2, S.SCALAR, R.ENVELOPE, P.PRICE),
         _o(3, S.BAND, R.ENVELOPE, P.PRICE)]),
    Id.FRACTIONAL_BANDS: _d(
        Id.FRACTIONAL_BANDS, "Jean-Philippe Poton", A.ADAPTIVE, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE),
         _o(1, S.SCALAR, R.ENVELOPE, P.PRICE),
         _o(2, S.SCALAR, R.ENVELOPE, P.PRICE),
         _o(3, S.BAND, R.ENVELOPE, P.PRICE)]),
    Id.HURST_DIFFERENCE: _d(
    ...
    Id.ADAPTIVE_EXPONENTIAL_MOVING_AVERAGE: _d(
        Id.ADAPTIVE_EXPONENTIAL_MOVING_AVERAGE, "Don Mak", A.ADAPTIVE, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE),
         _o(1, S.SCALAR, R.CYCLE_PERIOD, P.OWN),
         _o(2, S.SCALAR, R.BOUNDED_OSCILLATOR, P.OWN)]),

    Id.INSTANTANEOUS_SINE_WAVE_PERIOD: _d(
        Id.INSTANTANEOUS_SINE_WAVE_PERIOD, "Don Mak", A.STATIC, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.CYCLE_PERIOD, P.OWN),
         _o(1, S.SCALAR, R.CYCLE_PERIOD, P.OWN),
         _o(2, S.SCALAR, R.OSCILLATOR, P.OWN),
         _o(3, S.SCALAR, R.OSCILLATOR, P.OWN),
         _o(4, S.SCALAR, R.OSCILLATOR, P.OWN),
         _o(5, S.SCALAR, R.CYCLE_PHASE, P.OWN),
         _o(6, S.SCALAR, R.OVERLAY, P.PRICE)]),

    Id.POLYNOMIAL_FIT_DERIVATIVE: _d(
        Id.POLYNOMIAL_FIT_DERIVATIVE, "Don Mak", A.STATIC, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.OSCILLATOR, P.OWN)]),

    Id.MEXICAN_HAT_WAVELET: _d(
        Id.MEXICAN_HAT_WAVELET, "Don Mak", A.STATIC, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.OSCILLATOR, P.OWN)]),

    Id.SINC_WAVELET_BANDPASS: _d(
        Id.SINC_WAVELET_BANDPASS, "Don Mak", A.STATIC, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.OSCILLATOR, P.OWN)]),

    Id.MODIFIED_EXPONENTIAL_MOVING_AVERAGE: _d(
        Id.MODIFIED_EXPONENTIAL_MOVING_AVERAGE, "Don Mak", A.STATIC, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE)]),

    Id.VELOCITY_CORRECTED_EXPONENTIAL_MOVING_AVERAGE: _d(
        Id.VELOCITY_CORRECTED_EXPONENTIAL_MOVING_AVERAGE, "Don Mak", A.STATIC, I.SCALAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.SMOOTHER, P.PRICE)]),
    ...
    Id.CANDLESTICK_MOMENTUM_INDEX: _d(
        ...
        [_o(0, S.SCALAR, R.BOUNDED_OSCILLATOR, P.OWN),
         _o(1, S.SCALAR, R.SIGNAL, P.OWN)]),
    Id.CANDLESTICK_STRENGTH_INDEX: _d(
        Id.CANDLESTICK_STRENGTH_INDEX, "William Blau", A.STATIC, I.BAR_INPUT, V.NO_VOLUME,
        [_o(0, S.SCALAR, R.BOUNDED_OSCILLATOR, P.OWN),
         _o(1, S.SCALAR, R.SIGNAL, P.OWN)]),
    Id.STOCHASTIC_MOMENTUM_INDEX: _d(
