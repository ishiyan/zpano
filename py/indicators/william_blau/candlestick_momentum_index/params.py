"""Candlestick Momentum Index parameters."""

from dataclasses import dataclass


@dataclass
class CandlestickMomentumIndexParams:
...
def default_params() -> CandlestickMomentumIndexParams:
    """Returns default parameters for the Candlestick Momentum Index indicator."""
    return CandlestickMomentumIndexParams()
