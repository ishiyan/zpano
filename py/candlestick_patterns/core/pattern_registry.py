"""Registry of candlestick pattern metadata keyed by PatternIdentifier."""
...
class PatternInfo:
    """Descriptive metadata for a single candlestick pattern.

    Attributes:
        mnemonic: Human-readable English name (e.g. "abandoned baby").
        kanji: Traditional Japanese name written in kanji, or None
            when no established Japanese term exists.
        reading: Phonetic reading in hiragana, or None when ``kanji``
            is None.
        description: Multi-sentence explanation of the pattern, its
...
PATTERN_REGISTRY: dict[PatternIdentifier, PatternInfo] = {
    PatternIdentifier.ABANDONED_BABY: PatternInfo(
        mnemonic="abandoned baby",
        kanji="捨て子線",
        reading="すてごせん",
        description=(
            "A three-candle reversal pattern. The first candle continues the "
    ...
    PatternIdentifier.ADVANCE_BLOCK: PatternInfo(
        mnemonic="advance block",
        kanji=None,
        reading=None,
        description=(
            "A three-candle bearish reversal pattern that appears during an "
    ...
    PatternIdentifier.BELT_HOLD: PatternInfo(
        mnemonic="belt hold",
        kanji="寄り付き坊主",
        reading="よりつきぼうず",
        description=(
            "A single-candle pattern with a long real body and no shadow on "
    ...
    PatternIdentifier.BREAKAWAY: PatternInfo(
        mnemonic="breakaway",
        kanji=None,
        reading=None,
        description=(
            "A five-candle reversal pattern. The first candle is a long body "
    ...
    PatternIdentifier.CLOSING_MARUBOZU: PatternInfo(
        mnemonic="closing marubozu",
        kanji="寄り切り坊主",
        reading="よりきりぼうず",
        description=(
            "A single-candle pattern with no shadow on the closing side. A "
    ...
    PatternIdentifier.CONCEALING_BABY_SWALLOW: PatternInfo(
        mnemonic="concealing baby swallow",
        kanji=None,
        reading=None,
        description=(
            "A four-candle bullish reversal pattern appearing in a downtrend. "
    ...
    PatternIdentifier.COUNTERATTACK: PatternInfo(
        mnemonic="counterattack",
        kanji="出会い線",
        reading="であいせん",
        description=(
            "A two-candle reversal pattern where the second candle opens "
    ...
    PatternIdentifier.DARK_CLOUD_COVER: PatternInfo(
        mnemonic="dark cloud cover",
        kanji="被せ線",
        reading="かぶせせん",
        description=(
            "A two-candle bearish reversal pattern. The first candle is a "
    ...
    PatternIdentifier.DOJI: PatternInfo(
        mnemonic="doji",
        kanji="同事",
        reading="どうじ",
        description=(
            "A single-candle pattern where the open and close are virtually "
    ...
    PatternIdentifier.DOJI_STAR: PatternInfo(
        mnemonic="doji star",
        kanji="同事星",
        reading="どうじぼし",
        description=(
            "A two-candle reversal pattern. The first candle is a long body "
    ...
    PatternIdentifier.DRAGONFLY_DOJI: PatternInfo(
        mnemonic="dragonfly doji",
        kanji="蜻蛉同事",
        reading="とんぼどうじ",
        description=(
            "A doji with a long lower shadow and no upper shadow, resembling "
    ...
    PatternIdentifier.ENGULFING: PatternInfo(
        mnemonic="engulfing",
        kanji="抱き線",
        reading="だきせん",
        description=(
            "A two-candle reversal pattern where the second candle's real "
    ...
    PatternIdentifier.EVENING_DOJI_STAR: PatternInfo(
        mnemonic="evening doji star",
        kanji="宵の明星同事",
        reading="よいのみょうじょうどうじ",
        description=(
            "A three-candle bearish reversal pattern and a stronger form of "
    ...
    PatternIdentifier.EVENING_STAR: PatternInfo(
        mnemonic="evening star",
        kanji="宵の明星",
        reading="よいのみょうじょう",
        description=(
            "A three-candle bearish reversal pattern. The first candle is a "
    ...
    PatternIdentifier.GRAVESTONE_DOJI: PatternInfo(
        mnemonic="gravestone doji",
        kanji="塔婆同事",
        reading="とうばどうじ",
        description=(
            "A doji with a long upper shadow and no lower shadow, resembling "
    ...
    PatternIdentifier.HAMMER: PatternInfo(
        mnemonic="hammer",
        kanji="鎚",
        reading="つち",
        description=(
            "A single-candle bullish reversal pattern at the bottom of a "
    ...
    PatternIdentifier.HANGING_MAN: PatternInfo(
        mnemonic="hanging man",
        kanji="首吊り線",
        reading="くびつりせん",
        description=(
            "A single-candle bearish reversal pattern at the top of an "
    ...
    PatternIdentifier.HARAMI: PatternInfo(
        mnemonic="harami",
        kanji="孕み線",
        reading="はらみせん",
        description=(
    ...
    PatternIdentifier.HARAMI_CROSS: PatternInfo(
        mnemonic="harami cross",
        kanji="孕み寄せ線",
        reading="はらみよせせん",
        description=(
            "A stronger variant of the harami where the second candle is a "
    ...
    PatternIdentifier.HIGH_WAVE: PatternInfo(
        mnemonic="high wave",
        kanji="高波",
        reading="たかなみ",
        description=(
            "A single-candle pattern characterized by a small real body and "
    ...
    PatternIdentifier.HIKKAKE: PatternInfo(
        mnemonic="hikkake",
        kanji=None,
        reading=None,
        description=(
            "A multi-candle pattern based on a failed inside bar breakout. "
    ...
    PatternIdentifier.HIKKAKE_MODIFIED: PatternInfo(
        mnemonic="hikkake modified",
        kanji=None,
        reading=None,
        description=(
            "A refined version of the hikkake with a double inside bar "
    ...
    PatternIdentifier.HOMING_PIGEON: PatternInfo(
        mnemonic="homing pigeon",
        kanji=None,
        reading=None,
        description=(
            "A two-candle bullish reversal pattern. Both candles are black, "
    ...
    PatternIdentifier.IDENTICAL_THREE_CROWS: PatternInfo(
        mnemonic="identical three crows",
        kanji="同事三羽",
        reading="どうじさんば",
        description=(
            "A three-candle bearish continuation pattern. Three consecutive "
    ...
    PatternIdentifier.IN_NECK: PatternInfo(
        mnemonic="in-neck",
        kanji="入り首線",
        reading="いりくびせん",
        description=(
            "A two-candle bearish continuation pattern. The first candle is "
    ...
    PatternIdentifier.INVERTED_HAMMER: PatternInfo(
    ...
    PatternIdentifier.KICKING: PatternInfo(
        mnemonic="kicking",
        kanji=None,
        reading=None,
        description=(
            "A two-candle pattern composed of two marubozu of opposite "
    ...
    PatternIdentifier.KICKING_BY_LENGTH: PatternInfo(
        mnemonic="kicking by length",
        kanji=None,
        reading=None,
        description=(
            "Same structure as the kicking pattern — two opposite-colored "
    ...
    PatternIdentifier.LADDER_BOTTOM: PatternInfo(
        mnemonic="ladder bottom",
        kanji=None,
        reading=None,
        description=(
            "A five-candle bullish reversal pattern. The first three candles "
    ...
    PatternIdentifier.LONG_LEGGED_DOJI: PatternInfo(
        mnemonic="long-legged doji",
        kanji="足長同事",
        reading="あしながどうじ",
        description=(
            "A doji with exceptionally long upper and lower shadows, "
    ...
    PatternIdentifier.LONG_LINE: PatternInfo(
        mnemonic="long line",
        kanji="大陽線・大陰線",
        reading="だいようせん・だいいんせん",
        description=(
            "A single candle with a long real body — white (bullish) or "
    ...
    PatternIdentifier.MARUBOZU: PatternInfo(
        mnemonic="marubozu",
        kanji="丸坊主",
        reading="まるぼうず",
        description=(
            "A single candle with no shadows at all — the open equals one "
    ...
    PatternIdentifier.MATCHING_LOW: PatternInfo(
        mnemonic="matching low",
        kanji="毛抜き底",
        reading="けぬきぞこ",
        description=(
            "A two-candle bullish reversal pattern. Two consecutive black "
    ...
    PatternIdentifier.MAT_HOLD: PatternInfo(
        mnemonic="mat hold",
        kanji=None,
        reading=None,
        description=(
            "A five-candle bullish continuation pattern. The first candle is "
    ...
    PatternIdentifier.MORNING_DOJI_STAR: PatternInfo(
        mnemonic="morning doji star",
        kanji="明けの明星同事",
        reading="あけのみょうじょうどうじ",
        description=(
            "A three-candle bullish reversal pattern and a stronger form of "
    ...
    PatternIdentifier.MORNING_STAR: PatternInfo(
        mnemonic="morning star",
        kanji="明けの明星",
        reading="あけのみょうじょう",
        description=(
            "A three-candle bullish reversal pattern. The first candle is a "
    ...
    PatternIdentifier.ON_NECK: PatternInfo(
        mnemonic="on-neck",
        kanji="当て首線",
        reading="あてくびせん",
        description=(
    ...
    PatternIdentifier.PIERCING: PatternInfo(
        mnemonic="piercing",
        kanji="切り込み線",
        reading="きりこみせん",
        description=(
            "A two-candle bullish reversal pattern. The first candle is a "
    ...
    PatternIdentifier.RICKSHAW_MAN: PatternInfo(
        mnemonic="rickshaw man",
        kanji="人力車夫",
        reading="じんりきしゃふ",
        description=(
            "A form of long-legged doji where the body is near the center "
    ...
    PatternIdentifier.RISING_FALLING_THREE_METHODS: PatternInfo(
        mnemonic="rising/falling three methods",
        kanji="上げ三法・下げ三法",
        reading="あげさんぽう・さげさんぽう",
        description=(
            "A five-candle continuation pattern. In the rising form, a long "
    ...
    PatternIdentifier.SEPARATING_LINES: PatternInfo(
        mnemonic="separating lines",
        kanji="振り分け線",
        reading="ふりわけせん",
        description=(
            "A two-candle continuation pattern where both candles open at "
    ...
    PatternIdentifier.SHOOTING_STAR: PatternInfo(
    ...
    PatternIdentifier.SHORT_LINE: PatternInfo(
        mnemonic="short line",
        kanji="小陽線・小陰線",
        reading="しょうようせん・しょういんせん",
        description=(
            "A single candle with a small real body — white (mildly "
    ...
    PatternIdentifier.SPINNING_TOP: PatternInfo(
        mnemonic="spinning top",
        kanji="コマ",
        reading="こま",
        description=(
            "A single-candle indecision pattern with a small real body and "
    ...
    PatternIdentifier.STALLED: PatternInfo(
        mnemonic="stalled pattern",
        kanji=None,
        reading=None,
        description=(
            "A three-candle bearish reversal pattern, also called a "
    ...
    PatternIdentifier.STICK_SANDWICH: PatternInfo(
        mnemonic="stick sandwich",
        kanji=None,
        reading=None,
        description=(
            "A three-candle bullish reversal pattern. Two black candles with "
    ...
    PatternIdentifier.TAKURI: PatternInfo(
        mnemonic="takuri",
        kanji="たくり線",
        reading="たくりせん",
        description=(
            "A single-candle bullish reversal pattern similar to the hammer "
    ...
    PatternIdentifier.TASUKI_GAP: PatternInfo(
        mnemonic="tasuki gap",
        kanji="たすき",
        reading="たすき",
        description=(
            "A three-candle continuation pattern. In the bullish form, two "
    ...
    PatternIdentifier.THREE_BLACK_CROWS: PatternInfo(
        mnemonic="three black crows",
        kanji="三羽烏",
        reading="さんばがらす",
        description=(
            "A three-candle bearish reversal pattern. Three consecutive long "
    ...
    PatternIdentifier.THREE_INSIDE: PatternInfo(
        mnemonic="three inside up/down",
        kanji="はらみ確認",
        reading="はらみかくにん",
        description=(
            "A three-candle reversal pattern that confirms a harami. The "
    ...
    PatternIdentifier.THREE_LINE_STRIKE: PatternInfo(
        mnemonic="three-line strike",
        kanji="三本連続線",
        reading="さんぼんれんぞくせん",
        description=(
            "A four-candle continuation pattern. Three consecutive candles "
    ...
    PatternIdentifier.THREE_OUTSIDE: PatternInfo(
        mnemonic="three outside up/down",
        kanji="抱き確認",
        reading="だきかくにん",
        description=(
            "A three-candle reversal pattern that confirms an engulfing "
    ...
    PatternIdentifier.THREE_STARS_IN_THE_SOUTH: PatternInfo(
        mnemonic="three stars in the south",
        kanji="南の三つ星",
        reading="みなみのみつぼし",
        description=(
            "A three-candle bullish reversal pattern. Three consecutive "
    ...
    PatternIdentifier.THREE_WHITE_SOLDIERS: PatternInfo(
        mnemonic="three white soldiers",
        kanji="赤三兵",
        reading="あかさんぺい",
        description=(
            "A three-candle bullish reversal pattern. Three consecutive long "
    ...
    PatternIdentifier.THRUSTING: PatternInfo(
        mnemonic="thrusting",
        kanji="差し込み線",
        reading="さしこみせん",
        description=(
    ...
    PatternIdentifier.TRISTAR: PatternInfo(
        mnemonic="tri-star",
        kanji="三つ星",
        reading="みつぼし",
        description=(
            "A three-candle reversal pattern composed of three consecutive "
    ...
    PatternIdentifier.TWO_CROWS: PatternInfo(
        mnemonic="two crows",
        kanji="二羽の烏",
        reading="にわのからす",
        description=(
    ...
    PatternIdentifier.UNIQUE_THREE_RIVER: PatternInfo(
        mnemonic="unique three river bottom",
        kanji=None,
        reading=None,
        description=(
            "A three-candle bullish reversal pattern. The first candle is "
    ...
    PatternIdentifier.UP_DOWN_GAP_SIDE_BY_SIDE_WHITE_LINES: PatternInfo(
        mnemonic="up/down-gap side-by-side white lines",
        kanji=None,
        reading=None,
        description=(
            "A three-candle continuation pattern. Two consecutive white "
    ...
    PatternIdentifier.UPSIDE_GAP_TWO_CROWS: PatternInfo(
    ...
    PatternIdentifier.X_SIDE_GAP_THREE_METHODS: PatternInfo(
        mnemonic="upside/downside gap three methods",
        kanji=None,
        reading=None,
        description=(
            "A three-candle continuation pattern. Two candles of the same "
