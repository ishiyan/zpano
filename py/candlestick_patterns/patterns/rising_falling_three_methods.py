...
def rising_falling_three_methods(self) -> float:
    ...
    mu_long5 = self._mu_greater(real_body(o5, c5), self._long_body, 1)
    ...
    if not (c5 * color1 > c1 * color1):
        return 0.0

    conf = t_product_all(mu_long1, mu_short2, mu_short3, mu_short4, mu_long5)
