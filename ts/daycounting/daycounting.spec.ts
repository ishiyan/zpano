...
describe('JulianDay conversion', () => {
    it('should convert between JD and date correctly', () => {
        ...
        testCases.forEach(([jd, year, month, day]) => {
            ...
            expect(m).toBe(month);
            expect(d).toBe(day);
            expect(dateToJd(year, month, day)).toBe(jd);
        });
    });
});
...
describe('eur30360', () => {
    it('should handle basic tests correctly', () => {
        expect(eur30360(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.21111111, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(eur30360(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(eur30360(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(eur30360(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_360, 16);
        expect(eur30360(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_360, 15);
        expect(eur30360(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_360, 16);
    });

    it('should calculate year fractions correctly', () => {
        expect(eur30360(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.58055556, 8);
    });
    ...
    it('should match Excel basis 4 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(eur30360(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('eur30360Model2', () => {
    it('should handle basic tests correctly', () => {
        expect(eur30360Model2(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.21111111, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(eur30360Model2(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(eur30360Model2(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(eur30360Model2(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_360, 16);
        expect(eur30360Model2(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_360, 15);
        expect(eur30360Model2(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_360, 16);
    });

    it('should calculate year fractions correctly', () => {
        expect(eur30360Model2(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.58055556, 8);
    });
    ...
    it('should match Excel basis 4 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(eur30360Model2(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('eur30360Model3', () => {
    it('should handle basic tests correctly', () => {
        expect(eur30360Model3(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.21111111, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(eur30360Model3(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(eur30360Model3(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(eur30360Model3(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_360, 16);
        expect(eur30360Model3(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_360, 15);
        expect(eur30360Model3(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_360, 16);
    });

    it('should calculate year fractions correctly', () => {
        expect(eur30360Model3(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.58055556, 8);
    });
    ...
    it('should match Excel basis 4 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(eur30360Model3(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('eur30360Plus', () => {
    it('should handle basic tests correctly', () => {
        expect(eur30360Plus(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.21111111, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(eur30360Plus(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(eur30360Plus(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(eur30360Plus(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_360, 16);
        expect(eur30360Plus(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_360, 15);
        expect(eur30360Plus(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_360, 16);
    });

    it('should calculate year fractions correctly', () => {
        expect(eur30360Plus(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.58055556, 8);
    });
    ...
    it('should match Excel basis 4 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(eur30360Plus(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('us30360', () => {
    it('should handle basic tests correctly', () => {
        expect(us30360(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.21111111, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(us30360(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(us30360(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(us30360(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_360, 16);
        expect(us30360(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_360, 15);
        expect(us30360(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_360, 16);
    });

    it('should calculate YEARFRAC basis 0 correctly', () => {
        expect(us30360(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.58055556, 8);
    });
    ...
    it('should match Excel basis 0 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(us30360(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('us30360Eom', () => {
    it('should handle basic tests correctly', () => {
        expect(us30360Eom(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.21111111, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(us30360Eom(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(us30360Eom(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(us30360Eom(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_360, 16);
        expect(us30360Eom(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_360, 15);
        expect(us30360Eom(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_360, 16);
    });

    it('should calculate YEARFRAC basis 0 correctly', () => {
        expect(us30360Eom(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.58055556, 8);
    });
    ...
    it('should match Excel basis 0 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(us30360Eom(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('us30360Nasd', () => {
    it('should handle basic tests correctly', () => {
        expect(us30360Nasd(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.21111111, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(us30360Nasd(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(us30360Nasd(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(us30360Nasd(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_360, 16);
        expect(us30360Nasd(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_360, 15);
        expect(us30360Nasd(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_360, 16);
    });

    it('should calculate YEARFRAC basis 0 correctly', () => {
        expect(us30360Nasd(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.58055556, 8);
    });
    ...
    it('should match Excel basis 0 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(us30360Nasd(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('thirty365', () => {
    it('should handle basic tests correctly', () => {
        expect(thirty365(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.20821918, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(thirty365(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(0.986301369863, 13);
        expect(thirty365(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(0.986301369863, 13);
        expect(thirty365(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(0.986301369863 + FD2_365, 13);
        expect(thirty365(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(0.986301369863 - FD2_365, 13);
        expect(thirty365(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_365, 16);
    });
});

describe('act365Fixed', () => {
    it('should handle time fractions correctly', () => {
        expect(act365Fixed(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(act365Fixed(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1.0027397260274, 13);
        expect(act365Fixed(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1.0027397260274 + FD2_365, 13);
        expect(act365Fixed(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1.0027397260274 - FD2_365, 13);
        expect(act365Fixed(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_365, 13);
    });

    it('should handle year fractions correctly', () => {
        expect(act365Fixed(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.57808219, 8);
    });
    ...
    it('should match Excel basis 3 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(act365Fixed(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('act360', () => {
    it('should handle basic test correctly', () => {
        expect(act360(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.2111111111111111, 16);
    });

    it('should handle time fractions correctly', () => {
        expect(act360(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1.0138888888889, 13);
        expect(act360(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1.0166666666667, 13);
        expect(act360(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1.0166666666667 + FD2_360, 13);
        expect(act360(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1.0166666666667 - FD2_360, 13);
        expect(act360(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_360, 13);
    });
    ...
    it('should match Excel basis 2 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(act360(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('actActExcel', () => {
    it('should handle time fractions correctly', () => {
        expect(actActExcel(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(actActExcel(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(actActExcel(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_366, 13);
        expect(actActExcel(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_366, 13);
        expect(actActExcel(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_366, 13);
    });

    it('should handle year fractions correctly', () => {
        expect(actActExcel(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.576388888888889, 13); // toBeCloseTo(0.57650273, 8)
    });
    ...
    it('should match Excel basis 1 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(actActExcel(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('actActIsda', () => {
    it('should handle basic tests correctly', () => {
        expect(actActIsda(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.20547945, 8);
        expect(actActIsda(2018, 12, 31, 2019, 1, 1)).toBeCloseTo(0, 8);
        expect(actActIsda(1994, 6, 30, 1997, 6, 30)).toBeCloseTo(2.99726027, 8);
        expect(actActIsda(1994, 2, 10, 1994, 6, 30)).toBeCloseTo(140 / 365, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(actActIsda(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(0.9972602739726, 13);
        expect(actActIsda(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(0.997271502358, 13);
        expect(actActIsda(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(0.9978186990045, 13);
        expect(actActIsda(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(0.9967243057115, 13);
        expect(actActIsda(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_366, 13);
    });

    it('should handle year fractions correctly', () => {
        expect(actActIsda(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.57650273, 8);
    });
    ...
    it('should match Excel basis 1 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(actActIsda(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('actActAfb', () => {
    it('should handle basic tests correctly', () => {
        expect(actActAfb(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.20547945, 8);
        expect(actActAfb(2018, 12, 31, 2019, 1, 1)).toBeCloseTo(0, 8);
        expect(actActAfb(1994, 6, 30, 1997, 6, 30)).toBeCloseTo(2.99726027, 8);
        expect(actActAfb(1994, 2, 10, 1994, 6, 30)).toBeCloseTo(140 / 365, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(actActAfb(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(0.9972602739726, 13);
        expect(actActAfb(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(0.997271502358, 13);
        expect(actActAfb(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(0.9978186990045, 13);
        expect(actActAfb(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(0.9967243057115, 13);
        expect(actActAfb(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(FD2_366, 13);
    });

    it('should handle year fractions correctly', () => {
        expect(actActAfb(2012, 1, 1, 2012, 7, 30)).toBeCloseTo(0.57650273, 8);
    });
    ...
    it('should match Excel basis 1 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(actActAfb(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
...
describe('act365Nonleap', () => {
    it('should handle basic tests correctly', () => {
        expect(act365Nonleap(2018, 12, 15, 2019, 3, 1)).toBeCloseTo(0.20821918, 8);
    });

    it('should handle time fractions correctly', () => {
        expect(act365Nonleap(2021, 1, 1, 2022, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(act365Nonleap(2020, 1, 1, 2021, 1, 1, 0.5, 0.5)).toBeCloseTo(1, 16);
        expect(act365Nonleap(2020, 1, 1, 2021, 1, 1, 0.4, 0.6)).toBeCloseTo(1 + FD2_365, 13);
        expect(act365Nonleap(2020, 1, 1, 2021, 1, 1, 0.6, 0.4)).toBeCloseTo(1 - FD2_365, 13);
        expect(act365Nonleap(2020, 1, 1, 2020, 1, 1, 0.4, 0.6)).toBeCloseTo(-0.0021917808219, 13);
    });
    ...
    it('should match Excel basis 3 results', () => {
        ...
        testCases.forEach(([y1, m1, d1, y2, m2, d2, expected, precision]) => {
            expect(act365Nonleap(y1, m1, d1, y2, m2, d2)).toBeCloseTo(expected, precision);
        });
    });
});
