...
/** Describes parameters to create an instance of the Money Flow Index indicator. */
export interface MoneyFlowIndexParams {
    /**
     ...
     *
     * If _undefined_, the bar component will have a default value (TypicalPrice).
     */
