/**
 * Describes parameters to create an instance of the Candlestick Strength Index indicator.
 *
 ...
 */
export interface CandlestickStrengthIndexParams {
    /**
...
export function defaultParams(): CandlestickStrengthIndexParams {
