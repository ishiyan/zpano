...
/**
 * Describes parameters to create an instance of the Ergodic Oscillator indicator.
 *
 ...
 * test-data naming.
 */
export interface ErgodicOscillatorParams {
    /**
...
export function defaultParams(): ErgodicOscillatorParams {
