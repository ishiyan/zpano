...
/**
 * Describes parameters to create an instance of the Parabolic Vertex indicator.
 *
 * The indicator has no numeric parameters; only the input price component is configurable.
 */
export interface ParabolicVertexParams {
    /**
...
export function defaultParams(): ParabolicVertexParams {
    return {};
}
