...
/**
 * Describes parameters to create an instance of the Cubic Vertex indicator.
 *
 * The indicator has no numeric parameters; only the input price component is configurable.
 */
export interface CubicVertexParams {
    /**
...
export function defaultParams(): CubicVertexParams {
    return {};
}
