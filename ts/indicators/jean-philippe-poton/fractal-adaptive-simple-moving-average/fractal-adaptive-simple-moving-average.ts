...
import { FractalAdaptiveSimpleMovingAverageParams } from './params';

/** Function to calculate mnemonic of a __FractalAdaptiveSimpleMovingAverage__ indicator. */
export const fractalAdaptiveSimpleMovingAverageMnemonic = (params: FractalAdaptiveSimpleMovingAverageParams): string =>
    'frasma('.concat(
...
/** Fractal Adaptive Simple Moving Average (FRASMA) line indicator. */
export class FractalAdaptiveSimpleMovingAverage extends LineIndicator {
    private _window: Array<number>;
    private _closes: Array<number>;
    private _period: number;
    private _normalSpeed: number;
    private _windowCount: number;
    private _log2P: number;
    private _ln2: number;
     ...
     **/
    public constructor(params: FractalAdaptiveSimpleMovingAverageParams) {
        super();
        ...
        this.mnemonic = fractalAdaptiveSimpleMovingAverageMnemonic(params);
        this.description = 'Fractal adaptive simple moving average ' + this.mnemonic;
        ...
        this._windowCount = 0;
        this.primed = false;
        this._log2P = Math.log(2.0 * period);
    ...
    public metadata(): IndicatorMetadata {
        return buildMetadata(
            IndicatorIdentifier.FractalAdaptiveSimpleMovingAverage,
            this.mnemonic,
            this.description,
    ...
    public update(sample: number): number {
        ...
        let priorNorm = (this._window[1] - priceMin) / priceRange;
        let length = 0.0;
        ...
        const fdi = 1.0 + (Math.log(length) + this._ln2) / this._log2P;
