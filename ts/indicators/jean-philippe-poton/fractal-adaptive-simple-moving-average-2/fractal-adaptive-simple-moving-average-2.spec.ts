...
import { FractalAdaptiveSimpleMovingAverage2 } from './fractal-adaptive-simple-moving-average-2';
...
describe('FractalAdaptiveSimpleMovingAverage2', () => {

    it('should return expected mnemonic', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 30, normalSpeed: 20 });
        expect(f.metadata().mnemonic).toBe('frasma2(30,20)');
    });

    it('should throw if period is less than 2', () => {
        expect(() => { new FractalAdaptiveSimpleMovingAverage2({ period: 1, normalSpeed: 20 }); }).toThrow();
    });

    it('should throw if normalSpeed is less than 1', () => {
        expect(() => { new FractalAdaptiveSimpleMovingAverage2({ period: 5, normalSpeed: 0 }); }).toThrow();
    });

    it('should have correct identifier in metadata', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 30, normalSpeed: 20 });
        expect(f.metadata().identifier).toBe(IndicatorIdentifier.FractalAdaptiveSimpleMovingAverage2);
    });

    it('should calculate expected output for period 5', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 5, normalSpeed: 20 });
    ...
    it('should calculate expected output for period 10', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 10, normalSpeed: 20 });
    ...
    it('should calculate expected output for period 15', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 15, normalSpeed: 20 });
    ...
    it('should calculate expected output for period 20', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 20, normalSpeed: 20 });
    ...
    it('should calculate expected output for period 50', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 50, normalSpeed: 20 });
    ...
    it('should calculate expected output for period 80', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 80, normalSpeed: 20 });
    ...
    it('should calculate expected output for period 120', () => {
        const f = new FractalAdaptiveSimpleMovingAverage2({ period: 120, normalSpeed: 20 });
