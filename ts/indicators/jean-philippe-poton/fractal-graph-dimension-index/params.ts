...
/** Describes parameters to create an instance of the fractal graph dimension index indicator. */
export interface FractalGraphDimensionIndexParams {
    /**
     * Period is the lookback period N for the fractal graph dimension computation.
     *
...
export function defaultParams(): FractalGraphDimensionIndexParams {
    return {
        period: 30,
    };
}
