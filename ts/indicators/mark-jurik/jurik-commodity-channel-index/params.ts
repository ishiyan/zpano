...
/** Describes parameters to create an instance of the Jurik Commodity Channel Index indicator. */
export interface JurikCommodityChannelIndexParams {
    /**
...
export function defaultParams(): JurikCommodityChannelIndexParams {
    return { length: 20 };
}
