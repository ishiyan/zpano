...
/** Describes parameters to create an instance of the Jurik Zero Lag Velocity indicator. */
export interface JurikZeroLagVelocityParams {
    /**
...
export function defaultParams(): JurikZeroLagVelocityParams {
    return { depth: 10 };
}
