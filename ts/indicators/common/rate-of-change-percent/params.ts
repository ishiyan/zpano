...
/** Describes parameters to create an instance of the Rate of Change Percent indicator. */
export interface RateOfChangePercentParams {
    /**
...
export function defaultParams(): RateOfChangePercentParams {
    return {
        length: 10,
    };
}
