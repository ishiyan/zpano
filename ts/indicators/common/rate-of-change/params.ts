...
/** Describes parameters to create an instance of the Rate of Change indicator. */
export interface RateOfChangeParams {
    /**
...
export function defaultParams(): RateOfChangeParams {
    return {
        length: 10,
    };
}
