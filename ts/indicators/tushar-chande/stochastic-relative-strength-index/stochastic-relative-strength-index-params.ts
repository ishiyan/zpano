...
/** Specifies the type of moving average to use for the Fast-D smoothing. */
...
/** Describes parameters to create an instance of the Stochastic Relative Strength Index indicator. */
export interface StochasticRelativeStrengthIndexParams {
    /**
