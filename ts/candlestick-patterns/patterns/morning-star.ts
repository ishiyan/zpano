...
const MORNING_STAR_PENETRATION = 0.3;
 ...
 */
export function morningStar(cp: CandlestickPatternsEngine): number {
    ...
    const threshold = b1.c + rb1 * MORNING_STAR_PENETRATION;
    const width = cp.fuzzRatio * rb1 * MORNING_STAR_PENETRATION;
