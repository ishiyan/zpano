...
mod tests {
    ...
    #[allow(clippy::excessive_precision)]
    fn test_expected_frama() -> Vec<f64> {
        vec![
    ...
    fn test_update_frama() {
        let input_mid = test_input_mid();
        let input_high = test_input_high();
        let input_low = test_input_low();
        let expected = test_expected_frama();
    ...
    fn test_update_fdim() {
        ...
        let input_high = test_input_high();
        let input_low = test_input_low();
        let expected_fdim = test_expected_fdim();
