...
const evening_star_penetration_factor = 0.3;

pub fn eveningStar(self: *const CandlestickPatterns) f64 {
    ...
    const threshold = b1.c - rb1 * evening_star_penetration_factor;
    const width = self.fuzz_ratio * rb1 * evening_star_penetration_factor;
