...
pub const descriptors = [_]Descriptor{
    ...
    // ── jean-philippe poton ───────────────────────────────────────────────
    .{ .identifier = .fractal_dimension_index, .family = "Jean-Philippe Poton", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }} },
    .{ .identifier = .fractal_graph_dimension_index, .family = "Jean-Philippe Poton", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 3, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 4, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 5, .shape = .band, .role = .envelope, .pane = .own } } },
    .{ .identifier = .fractal_adaptive_simple_moving_average, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }} },
    .{ .identifier = .fractal_adaptive_simple_moving_average_2, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }} },
    .{ .identifier = .rescaled_fractal_adaptive_simple_moving_average, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }} },
    .{ .identifier = .fractal_bands, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }, .{ .kind = 2, .shape = .scalar, .role = .envelope, .pane = .price }, .{ .kind = 3, .shape = .scalar, .role = .envelope, .pane = .price }, .{ .kind = 4, .shape = .band, .role = .envelope, .pane = .price } } },
    .{ .identifier = .fractal_bands_hybride_adaptive, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }, .{ .kind = 2, .shape = .scalar, .role = .envelope, .pane = .price }, .{ .kind = 3, .shape = .scalar, .role = .envelope, .pane = .price }, .{ .kind = 4, .shape = .band, .role = .envelope, .pane = .price } } },
    .{ .identifier = .fractional_bands, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }, .{ .kind = 2, .shape = .scalar, .role = .envelope, .pane = .price }, .{ .kind = 3, .shape = .scalar, .role = .envelope, .pane = .price }, .{ .kind = 4, .shape = .band, .role = .envelope, .pane = .price } } },
    .{ .identifier = .hurst_difference, .family = "Jean-Philippe Poton", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .oscillator, .pane = .own } } },

    // ── doug schaff ───────────────────────────────────────────────────────
    .{ .identifier = .schaff_trend_cycle, .family = "Doug Schaff", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .bounded_oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 3, .shape = .scalar, .role = .bounded_oscillator, .pane = .own } } },

    // ── don mak ───────────────────────────────────────────────────────────
    .{ .identifier = .adaptive_exponential_moving_average, .family = "Don Mak", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }, .{ .kind = 2, .shape = .scalar, .role = .cycle_period, .pane = .own }, .{ .kind = 3, .shape = .scalar, .role = .bounded_oscillator, .pane = .own } } },
    .{ .identifier = .instantaneous_sine_wave_period, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .cycle_period, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .cycle_period, .pane = .own }, .{ .kind = 3, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 4, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 5, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 6, .shape = .scalar, .role = .cycle_phase, .pane = .own }, .{ .kind = 7, .shape = .scalar, .role = .overlay, .pane = .price } } },
    .{ .identifier = .polynomial_fit_derivative, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }} },
    .{ .identifier = .mexican_hat_wavelet, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }} },
    .{ .identifier = .sinc_wavelet_bandpass, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }} },
    .{ .identifier = .modified_exponential_moving_average, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }} },
    .{ .identifier = .velocity_corrected_exponential_moving_average, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .smoother, .pane = .price }} },
    .{ .identifier = .polynomial_forecast, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .forecast, .pane = .price }} },
    .{ .identifier = .parabolic_vertex, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .reversal, .pane = .own }} },
    .{ .identifier = .cubic_vertex, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .reversal, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .reversal, .pane = .own } } },
    .{ .identifier = .quantum_price_levels, .family = "Raymond Lee", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .volatility, .pane = .own }, .{ .kind = 3, .shape = .levels, .role = .distribution, .pane = .own }, .{ .kind = 4, .shape = .levels, .role = .support_resistance, .pane = .price }, .{ .kind = 5, .shape = .levels, .role = .support_resistance, .pane = .price } } },
    .{ .identifier = .moving_mini_max, .family = "Zurab Silagadze", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .reversal, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .reversal, .pane = .own }, .{ .kind = 3, .shape = .levels, .role = .support_resistance, .pane = .price }, .{ .kind = 4, .shape = .levels, .role = .support_resistance, .pane = .price }, .{ .kind = 5, .shape = .polyline, .role = .distribution, .pane = .own }, .{ .kind = 6, .shape = .polyline, .role = .distribution, .pane = .own } } },
    ...
    .{ .identifier = .mean_deviation_index, .family = "William Blau", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .signal, .pane = .own } } },
    .{ .identifier = .macd_index, .family = "William Blau", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .signal, .pane = .own } } },
    .{ .identifier = .double_smoothed_momenta, .family = "William Blau", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .bounded_oscillator, .pane = .own }} },
    .{ .identifier = .candlestick_momentum_index, .family = "William Blau", .adaptivity = .static_, .input_requirement = .bar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .bounded_oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .signal, .pane = .own } } },
    .{ .identifier = .candlestick_strength_index, .family = "William Blau", .adaptivity = .static_, .input_requirement = .bar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .bounded_oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .signal, .pane = .own } } },
    .{ .identifier = .stochastic_momentum_index, .family = "William Blau", .adaptivity = .static_, .input_requirement = .bar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .bounded_oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .signal, .pane = .own } } },
    .{ .identifier = .double_smoothed_stochastic, .family = "William Blau", .adaptivity = .static_, .input_requirement = .bar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .bounded_oscillator, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .signal, .pane = .own } } },
};
