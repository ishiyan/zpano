...
pub const descriptors = [_]Descriptor{
    ...
    .{ .identifier = .polynomial_forecast, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .signal, .pane = .price }} },
    .{ .identifier = .parabolic_vertex, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 1, .shape = .scalar, .role = .signal, .pane = .own }} },
    .{ .identifier = .cubic_vertex, .family = "Don Mak", .adaptivity = .static_, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 1, .shape = .scalar, .role = .signal, .pane = .own }, .{ .kind = 2, .shape = .scalar, .role = .signal, .pane = .own } } },
};
