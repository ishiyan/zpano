...
pub const descriptors = [_]Descriptor{
    ...
    .{ .identifier = .fractal_adaptive_simple_moving_average, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 0, .shape = .scalar, .role = .smoother, .pane = .price }} },
    .{ .identifier = .fractal_adaptive_simple_moving_average_2, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 0, .shape = .scalar, .role = .smoother, .pane = .price }} },
    .{ .identifier = .rescaled_fractal_adaptive_simple_moving_average, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{.{ .kind = 0, .shape = .scalar, .role = .smoother, .pane = .price }} },
    .{ .identifier = .fractal_bands, .family = "Jean-Philippe Poton", .adaptivity = .adaptive, .input_requirement = .scalar_input, .volume_usage = .no_volume, .outputs = &[_]OD{ .{ .kind = 0, .shape = .scalar, .role = .smoother, .pane = .price }, .{ .kind = 1, .shape = .scalar, .role = .envelope, .pane = .price }, .{ .kind = 2, .shape = .scalar, .role = .envelope, .pane = .price }, .{ .kind = 3, .shape = .band, .role = .envelope, .pane = .price } } },
