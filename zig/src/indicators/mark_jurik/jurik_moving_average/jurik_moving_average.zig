...
fn expectedLen20PhaseMin100() [252]f64 {
    return .{
...
fn expectedLen20Phase0() [252]f64 {
    return .{
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
...
fn expectedLen20Phase100() [252]f64 {
    return .{
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
...
fn expectedLen10Phase1() [252]f64 {
    return .{
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
        math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),       math.nan(f64),
...
fn expectedLen20PhaseMin30() [252]f64 {
...
fn expectedLen20Phase30() [252]f64 {
    const nan = math.nan(f64);
    return .{
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
...
fn expectedLen25Phase1() [252]f64 {
    const nan = math.nan(f64);
    return .{
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
...
fn expectedLen50Phase1() [252]f64 {
    const nan = math.nan(f64);
    return .{
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
...
fn expectedLen75Phase1() [252]f64 {
    const nan = math.nan(f64);
    return .{
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
...
fn expectedLen100Phase1() [252]f64 {
    const nan = math.nan(f64);
    return .{
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
        nan,                 nan,                 nan,                 nan,                 nan,                 nan,
...
test "jurik moving average length 20 phase -30" {
    try runJmaTest(20, -30, expectedLen20PhaseMin30());
}

test "jurik moving average length 20 phase 30" {
    try runJmaTest(20, 30, expectedLen20Phase30());
}

test "jurik moving average length 2 phase 1" {
    try runJmaTest(2, 1, expectedLen2Phase1());
}

test "jurik moving average length 5 phase 1" {
    try runJmaTest(5, 1, expectedLen5Phase1());
}

test "jurik moving average length 25 phase 1" {
    try runJmaTest(25, 1, expectedLen25Phase1());
}

test "jurik moving average length 50 phase 1" {
    try runJmaTest(50, 1, expectedLen50Phase1());
}

test "jurik moving average length 75 phase 1" {
    try runJmaTest(75, 1, expectedLen75Phase1());
}

test "jurik moving average length 100 phase 1" {
    try runJmaTest(100, 1, expectedLen100Phase1());
}

test "jurik moving average length 20 phase -100" {
    try runJmaTest(20, -100, expectedLen20PhaseMin100());
}

test "jurik moving average length 20 phase 0" {
    try runJmaTest(20, 0, expectedLen20Phase0());
}

test "jurik moving average length 20 phase 100" {
    try runJmaTest(20, 100, expectedLen20Phase100());
}

test "jurik moving average length 10 phase 1" {
    try runJmaTest(10, 1, expectedLen10Phase1());
}
