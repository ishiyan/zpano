...
pub const SpotValue = struct { i: usize, v: f64 };

pub const test_input = [_]f64{
...
pub const test_min_max_tol = 1e-9;

pub const GsSnap = struct {
    i: usize,
    value_min: f64,
    value_max: f64,
...
pub const goertzel_snapshots = [_]GsSnap{
    .{
        .i = 63,
        .value_min = 0,
        .value_max = 1,
