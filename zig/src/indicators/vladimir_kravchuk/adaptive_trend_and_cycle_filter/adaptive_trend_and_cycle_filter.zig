...
fn testATCFSnapshots() [15]AtcfSnap {
    const nan = math.nan(f64);
    return .{
        .{ .i = 0, .fatl = nan, .satl = nan, .rftl = nan, .rstl = nan, .rbci = nan, .ftlm = nan, .stlm = nan, .pcci = nan },
        .{ .i = 38, .fatl = 84.9735715498821, .satl = nan, .rftl = nan, .rstl = nan, .rbci = nan, .ftlm = nan, .stlm = nan, .pcci = -1.3160715498821 },
        .{ .i = 39, .fatl = 84.4518660416872, .satl = nan, .rftl = nan, .rstl = nan, .rbci = nan, .ftlm = nan, .stlm = nan, .pcci = 0.0031339583128 },
        .{ .i = 43, .fatl = 88.2793028340854, .satl = nan, .rftl = 84.9781981272507, .rstl = nan, .rbci = nan, .ftlm = 3.3011047068347, .stlm = nan, .pcci = 0.9856971659146 },
        .{ .i = 44, .fatl = 90.3071933727095, .satl = nan, .rftl = 85.3111711946473, .rstl = nan, .rbci = nan, .ftlm = 4.9960221780622, .stlm = nan, .pcci = 0.5528066272905 },
        .{ .i = 55, .fatl = 83.5737547263234, .satl = nan, .rftl = 87.6545375029340, .rstl = nan, .rbci = -701.3930208567576, .ftlm = -4.0807827766106, .stlm = nan, .pcci = 0.6762452736766 },
        .{ .i = 56, .fatl = 84.2004074439195, .satl = nan, .rftl = 86.4101353078987, .rstl = nan, .rbci = -596.7632782263086, .ftlm = -2.2097278639792, .stlm = nan, .pcci = 1.4870925560805 },
        .{ .i = 64, .fatl = 91.3026041176860, .satl = 89.8909098632724, .rftl = 89.2605446508615, .rstl = nan, .rbci = 260.0958399205915, .ftlm = 2.0420594668245, .stlm = nan, .pcci = 0.3698958823140 },
        .{ .i = 65, .fatl = 91.9122247829182, .satl = 90.3013166280409, .rftl = 90.0608560382592, .rstl = nan, .rbci = 271.4055284612814, .ftlm = 1.8513687446590, .stlm = nan, .pcci = 0.6802752170818 },
        .{ .i = 90, .fatl = 115.0676036598003, .satl = 109.5130909788342, .rftl = 106.9904903948140, .rstl = 91.0255929287335, .rbci = 648.4101282691054, .ftlm = 8.0771132649863, .stlm = 18.4874980501007, .pcci = 4.9323963401997 },
        .{ .i = 91, .fatl = 117.8447026727287, .satl = 111.5377810965825, .rftl = 108.9908122410267, .rstl = 91.4218609612485, .rbci = 750.5214819459538, .ftlm = 8.8538904317020, .stlm = 20.1159201353340, .pcci = 2.0302973272713 },
        .{ .i = 100, .fatl = 112.8634350429428, .satl = 119.4023289602100, .rftl = 115.8265249211198, .rstl = 97.7871686087879, .rbci = -617.3149799371608, .ftlm = -2.9630898781769, .stlm = 21.6151603514221, .pcci = 1.8815649570572 },
        .{ .i = 150, .fatl = 121.5097808704445, .satl = 124.0945687443045, .rftl = 123.2003217712845, .rstl = 127.9357790331669, .rbci = -268.9358266646477, .ftlm = -1.6905409008400, .stlm = -3.8412102888624, .pcci = 1.2702191295555 },
        .{ .i = 200, .fatl = 106.1833142820738, .satl = 109.8912725552509, .rftl = 109.8071754394800, .rstl = 127.4173713354640, .rbci = -592.7380669351005, .ftlm = -3.6238611574062, .stlm = -17.5260987802131, .pcci = 0.7866857179262 },
        .{ .i = 251, .fatl = 108.1030068950443, .satl = 114.1981767327412, .rftl = 110.1319723971535, .rstl = 102.4461386298790, .rbci = -312.3373212974634, .ftlm = -2.0289655021092, .stlm = 11.7520381028621, .pcci = -0.0430068950443 },
    };
}

fn closeEnough(exp: f64, got: f64) bool {
    if (math.isNan(exp)) return math.isNan(got);
    return @abs(exp - got) <= test_tolerance;
}
...
test "atcf update" {
    ...
    const input = testATCFInput();
    const snaps = testATCFSnapshots();
