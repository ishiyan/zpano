...
pub static DESCRIPTORS: &[Descriptor] = &[
    ...
    Descriptor {
        ...
        outputs: &[
            ...
            OutputDescriptor { kind: 5, shape: Band, role: Envelope, pane: Own },
        ],
    },
    Descriptor {
    ...
    Descriptor {
        ...
        outputs: &[
            ...
            OutputDescriptor { kind: 6, shape: Scalar, role: CyclePhase, pane: Own },
            OutputDescriptor { kind: 7, shape: Scalar, role: Overlay, pane: Price },
        ],
    },
    Descriptor {
