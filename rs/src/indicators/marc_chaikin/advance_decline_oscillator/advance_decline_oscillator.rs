...
mod tests {
    ...
    fn test_expected_sma() -> Vec<f64> {
        vec![
            f64::NAN, f64::NAN, f64::NAN, f64::NAN, f64::NAN,
            f64::NAN, f64::NAN, f64::NAN, f64::NAN, 815959.29,
    ...
    fn test_advance_decline_oscillator_ema() {
        ...
        let expected = test_expected_ema();
    ...
    fn test_advance_decline_oscillator_sma() {
        ...
        let closes = test_closes();
        let volumes = test_volumes();
        let expected = test_expected_sma();
