...
mod tests {
    ...
    fn test_expected_trend_line() -> Vec<f64> {
        vec![
    ...
    fn test_expected_trigger() -> Vec<f64> {
        vec![
            f64::NAN, f64::NAN, f64::NAN, f64::NAN,
    ...
    fn test_update_trend_line() {
        ...
        let exp = test_expected_trend_line();
    ...
    fn test_update_trigger_line() {
        let mut itl = create_default();
        let input = test_input();
        let exp_trig = test_expected_trigger();
    ...
    fn test_update_entity_scalar() {
        let mut itl = create_default();
        let input = test_input();
        let exp_trend = test_expected_trend_line();
        let exp_trigger = test_expected_trigger();
    ...
    fn test_update_entity_bar() {
        let mut itl = create_default();
        let input_high = test_input_high();
        let input_low = test_input_low();
        let exp_trend = test_expected_trend_line();
        let exp_trigger = test_expected_trigger();
