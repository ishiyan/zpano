...
mod tests {
    ...
    fn expected_smoothed() -> Vec<f64> {
        vec![
            f64::NAN, f64::NAN, f64::NAN, 94.366250, 94.596250,
    ...
    fn expected_detrended() -> Vec<f64> {
        vec![
            f64::NAN, f64::NAN, f64::NAN, 8.98725291750000000, 9.00915765750000000,
    ...
    fn expected_quadrature() -> Vec<f64> {
        vec![
            f64::NAN, f64::NAN, f64::NAN, 0.8559279933568650, 0.8580141569849850,
    ...
    fn expected_in_phase() -> Vec<f64> {
        vec![
            f64::NAN, f64::NAN, f64::NAN, 0.0000000000000000, 0.0000000000000000,
    ...
    fn expected_period() -> Vec<f64> {
        vec![
            f64::NAN, f64::NAN, f64::NAN, 6.000000000000000, 6.000000000000000,
