use super::pattern_identifier::PATTERN_COUNT;

/// PatternInfo contains descriptive metadata for a single candlestick pattern.
#[derive(Debug, Clone, Copy, PartialEq)]
pub struct PatternInfo {
    /// Human-readable English name (e.g. "abandoned baby").
    pub mnemonic: &'static str,
    /// Traditional Japanese name written in kanji, or empty when no established term exists.
...
pub const PATTERN_REGISTRY: [PatternInfo; PATTERN_COUNT] = [
    // AbandonedBaby
    PatternInfo {
