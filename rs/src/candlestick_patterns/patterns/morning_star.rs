...
const MORNING_STAR_PENETRATION_FACTOR: f64 = 0.3;
...
pub fn morning_star(cp: &CandlestickPatterns) -> f64 {
    ...
    let threshold = b1.c + rb1 * MORNING_STAR_PENETRATION_FACTOR;
    let width = cp.fuzz_ratio * rb1 * MORNING_STAR_PENETRATION_FACTOR;
