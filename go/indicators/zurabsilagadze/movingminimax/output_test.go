...
func TestOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{Up, upStr},
		{Down, downStr},
		{Resistances, resistStr},
		{Supports, supportsStr},
		{UpDistribution, upDistStr},
		{DownDistribution, downDistStr},
...
func TestOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{Up, dqs + upStr + dqs, true},
		{Down, dqs + downStr + dqs, true},
		{Resistances, dqs + resistStr + dqs, true},
		{Supports, dqs + supportsStr + dqs, true},
		{UpDistribution, dqs + upDistStr + dqs, true},
		{DownDistribution, dqs + downDistStr + dqs, true},
