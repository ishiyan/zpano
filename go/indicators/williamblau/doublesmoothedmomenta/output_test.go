...
func TestDoubleSmoothedMomentaOutputString(t *testing.T) {
	t.Parallel()
...
func TestDoubleSmoothedMomentaOutputIsKnown(t *testing.T) {
	t.Parallel()
...
func TestDoubleSmoothedMomentaOutputMarshalJSON(t *testing.T) {
	t.Parallel()
...
func TestDoubleSmoothedMomentaOutputUnmarshalJSON(t *testing.T) {
	t.Parallel()
