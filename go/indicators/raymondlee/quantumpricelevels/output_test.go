...
func TestOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{Lambda, lambdaStr},
		{ReturnStdDev, returnStdDevStr},
		{NormalizedMultipliers, nqprStr},
...
func TestOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{Lambda, dqs + lambdaStr + dqs, true},
		{ReturnStdDev, dqs + returnStdDevStr + dqs, true},
		{NormalizedMultipliers, dqs + nqprStr + dqs, true},
		{Resistances, dqs + resistancesStr + dqs, true},
