...
func TestT3ExponentialMovingAverageOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{Value, t3ExponentialMovingAverageValueStr},
		{outputLast, t3ExponentialMovingAverageUnknownStr},
		{Output(0), t3ExponentialMovingAverageUnknownStr},
		{Output(9999), t3ExponentialMovingAverageUnknownStr},
		{Output(-9999), t3ExponentialMovingAverageUnknownStr},
	}
...
func TestT3ExponentialMovingAverageOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{Value, dqs + t3ExponentialMovingAverageValueStr + dqs, true},
