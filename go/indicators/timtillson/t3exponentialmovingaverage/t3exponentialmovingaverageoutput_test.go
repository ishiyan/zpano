...
func TestT3ExponentialMovingAverageOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{T3ExponentialMovingAverageValue, t3ExponentialMovingAverageValueStr},
		{t3ExponentialMovingAverageLast, t3ExponentialMovingAverageUnknownStr},
		{T3ExponentialMovingAverageOutput(0), t3ExponentialMovingAverageUnknownStr},
		{T3ExponentialMovingAverageOutput(9999), t3ExponentialMovingAverageUnknownStr},
		{T3ExponentialMovingAverageOutput(-9999), t3ExponentialMovingAverageUnknownStr},
	}
...
func TestT3ExponentialMovingAverageOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{T3ExponentialMovingAverageValue, dqs + t3ExponentialMovingAverageValueStr + dqs, true},
...
func TestT3ExponentialMovingAverageOutputUnmarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{T3ExponentialMovingAverageValue, dqs + t3ExponentialMovingAverageValueStr + dqs, true},
		{zero, dqs + t3ExponentialMovingAverageUnknownStr + dqs, false},
