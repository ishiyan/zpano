...
func TestT2ExponentialMovingAverageOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{Value, t2ExponentialMovingAverageValueStr},
		{outputLast, t2ExponentialMovingAverageUnknownStr},
		{Output(0), t2ExponentialMovingAverageUnknownStr},
		{Output(9999), t2ExponentialMovingAverageUnknownStr},
		{Output(-9999), t2ExponentialMovingAverageUnknownStr},
	}
...
func TestT2ExponentialMovingAverageOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{Value, dqs + t2ExponentialMovingAverageValueStr + dqs, true},
