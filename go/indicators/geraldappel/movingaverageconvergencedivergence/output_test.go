...
func TestOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{MACD, mACDValueStr},
		{Signal, signalValueStr},
		{Histogram, histogramValueStr},
...
func TestOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{MACD, dqs + mACDValueStr + dqs, true},
		{Signal, dqs + signalValueStr + dqs, true},
		{Histogram, dqs + histogramValueStr + dqs, true},
