...
func TestOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{Period, dqs + periodStr + dqs, true},
		{Omega, dqs + omegaStr + dqs, true},
		{Velocity, dqs + velocityStr + dqs, true},
		{Acceleration, dqs + accelerationStr + dqs, true},
		{Amplitude, dqs + amplitudeStr + dqs, true},
		{Phase, dqs + phaseStr + dqs, true},
		{DcLevel, dqs + dcLevelStr + dqs, true},
