...
// DefaultParams returns a [WilliamsPercentRParams] value populated with conventional defaults.
func DefaultParams() *WilliamsPercentRParams {
	return &WilliamsPercentRParams{
		Length: 14,
	}
}
