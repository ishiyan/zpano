...
func TestOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{Lower, lowerValueStr},
		{Middle, middleValueStr},
		{Upper, upperValueStr},
		{BandWidth, bandWidthStr},
		{PercentBand, percentBandStr},
		{Band, bandStr},
...
func TestOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{Lower, dqs + lowerValueStr + dqs, true},
		{Middle, dqs + middleValueStr + dqs, true},
		{Upper, dqs + upperValueStr + dqs, true},
		{BandWidth, dqs + bandWidthStr + dqs, true},
		{PercentBand, dqs + percentBandStr + dqs, true},
