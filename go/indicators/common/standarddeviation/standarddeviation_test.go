...
// testStandardDeviationInput is the input data to test standard deviation calculations.
func testStandardDeviationInput() []float64 {
	return []float64{
...
// testStandardDeviationLength5PopulationExpected is the Excel (STDEV.P) output of standard deviation
// based on population variance of length 5.
//
//nolint:dupl
func testStandardDeviationLength5PopulationExpected() []float64 {
	return []float64{
...
// testStandardDeviationLength5SampleExpected is the Excel (STDEV.S) output of standard deviation
// based on the unbiased estimation of the sample variance of length 5.
//
//nolint:dupl
func testStandardDeviationLength5SampleExpected() []float64 {
	return []float64{
		math.NaN(), math.NaN(), math.NaN(), math.NaN(),
