...
func TestOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{SlopeRad, slopeRadStr},
		{SlopeDeg, slopeDegStr},
...
func TestOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{Forecast, dqs + forecastStr + dqs, true},
		{Intercept, dqs + interceptStr + dqs, true},
		{SlopeRad, dqs + slopeRadStr + dqs, true},
		{SlopeDeg, dqs + slopeDegStr + dqs, true},
