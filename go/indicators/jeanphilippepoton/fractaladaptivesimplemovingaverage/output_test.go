...
func TestFractalAdaptiveSimpleMovingAverageOutputString(t *testing.T) {
	t.Parallel()
...
func TestFractalAdaptiveSimpleMovingAverageOutputIsKnown(t *testing.T) {
	t.Parallel()
...
func TestFractalAdaptiveSimpleMovingAverageOutputMarshalJSON(t *testing.T) {
	t.Parallel()
...
func TestFractalAdaptiveSimpleMovingAverageOutputUnmarshalJSON(t *testing.T) {
	t.Parallel()
