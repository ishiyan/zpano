...
func TestFractalAdaptiveSimpleMovingAverage2OutputString(t *testing.T) {
	t.Parallel()
...
func TestFractalAdaptiveSimpleMovingAverage2OutputIsKnown(t *testing.T) {
	t.Parallel()
...
func TestFractalAdaptiveSimpleMovingAverage2OutputMarshalJSON(t *testing.T) {
	t.Parallel()
...
func TestFractalAdaptiveSimpleMovingAverage2OutputUnmarshalJSON(t *testing.T) {
	t.Parallel()
