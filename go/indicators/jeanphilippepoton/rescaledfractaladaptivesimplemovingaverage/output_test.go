...
func TestRescaledFractalAdaptiveSimpleMovingAverageOutputString(t *testing.T) {
	t.Parallel()
...
func TestRescaledFractalAdaptiveSimpleMovingAverageOutputIsKnown(t *testing.T) {
	t.Parallel()
...
func TestRescaledFractalAdaptiveSimpleMovingAverageOutputMarshalJSON(t *testing.T) {
	t.Parallel()
...
func TestRescaledFractalAdaptiveSimpleMovingAverageOutputUnmarshalJSON(t *testing.T) {
	t.Parallel()
