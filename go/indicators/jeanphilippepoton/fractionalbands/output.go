...
const (
	...
	// Upper is the upper band (frasma2 + FBM-scaled deviation).
	Upper
	// Lower is the lower band (frasma2 - FBM-scaled deviation).
	Lower
...
func (o Output) MarshalJSON() ([]byte, error) {
	const (
		errFmt = "cannot marshal '%s': unknown fractional bands output"
		extra  = 2
		dqc    = '"'
	)
...
func (o *Output) UnmarshalJSON(data []byte) error {
	const (
		errFmt = "cannot unmarshal '%s': unknown fractional bands output"
		dqs    = "\""
	)
