...
// https://github.com/flare9x/MarketCycles.jl/blob/master/test/test_3-3_Supersmoother.csv
// (10-period super smoother) from Julia reference implementation
// https://github.com/flare9x/MarketCycles.jl/blob/master/src/ehlers_cycles.jl

func testSuperSmootherInput() []float64 {
	return []float64{
...
func testSuperSmootherExpected() []float64 {
	return []float64{
...
func testSuperSmootherTime() time.Time {
