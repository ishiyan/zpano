...
func TestOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{RelativeStrengthIndexValue, relativeStrengthIndexOutputValue},
		{relativeStrengthIndexLast, relativeStrengthIndexOutputUnknown},
		{RelativeStrengthIndexOutput(0), relativeStrengthIndexOutputUnknown},
		{RelativeStrengthIndexOutput(9999), relativeStrengthIndexOutputUnknown},
		{RelativeStrengthIndexOutput(-9999), relativeStrengthIndexOutputUnknown},
	}
...
func TestOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{RelativeStrengthIndexValue, dqs + relativeStrengthIndexOutputValue + dqs, true},
...
func TestOutputUnmarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{RelativeStrengthIndexValue, dqs + relativeStrengthIndexOutputValue + dqs, true},
		{zero, dqs + relativeStrengthIndexOutputUnknown + dqs, false},
