...
func TestOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{TrueRangeValue, trueRangeOutputValue},
		{trueRangeLast, trueRangeOutputUnknown},
		{TrueRangeOutput(0), trueRangeOutputUnknown},
		{TrueRangeOutput(9999), trueRangeOutputUnknown},
		{TrueRangeOutput(-9999), trueRangeOutputUnknown},
	}
...
func TestOutputIsKnown(t *testing.T) {
	...
	tests := []struct {
		...
		{TrueRangeValue, true},
		{trueRangeLast, false},
		{TrueRangeOutput(0), false},
		{TrueRangeOutput(9999), false},
		{TrueRangeOutput(-9999), false},
	}
...
func TestOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{TrueRangeValue, dqs + trueRangeOutputValue + dqs, true},
		{trueRangeLast, nilstr, false},
		{TrueRangeOutput(9999), nilstr, false},
		{TrueRangeOutput(-9999), nilstr, false},
		{TrueRangeOutput(0), nilstr, false},
	}
...
func TestOutputUnmarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{TrueRangeValue, dqs + trueRangeOutputValue + dqs, true},
		{zero, dqs + trueRangeOutputUnknown + dqs, false},
