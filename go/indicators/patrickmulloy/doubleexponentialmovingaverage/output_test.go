...
func TestDoubleExponentialMovingAverageOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{Value, doubleExponentialMovingAverageValueStr},
		{outputLast, doubleExponentialMovingAverageUnknownStr},
		{Output(0), doubleExponentialMovingAverageUnknownStr},
		{Output(9999), doubleExponentialMovingAverageUnknownStr},
		{Output(-9999), doubleExponentialMovingAverageUnknownStr},
	}
...
func TestDoubleExponentialMovingAverageOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{Value, dqs + doubleExponentialMovingAverageValueStr + dqs, true},
