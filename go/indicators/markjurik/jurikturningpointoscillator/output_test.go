...
func TestTurningPointOscillatorOutputString(t *testing.T) {
	t.Parallel()
	tests := []struct {
		o    Output
		text string
...
func TestTurningPointOscillatorOutputIsKnown(t *testing.T) {
	t.Parallel()
	tests := []struct {
		o       Output
		boolean bool
		...
		{Value, true},
		{turningPointOscillatorLast, false},
		{Output(0), false},
		{Output(9999), false},
		{Output(-9999), false},
	}
...
func TestTurningPointOscillatorOutputMarshalJSON(t *testing.T) {
	t.Parallel()
	const dqs = "\""
	var nilstr string
	tests := []struct {
...
func TestTurningPointOscillatorOutputUnmarshalJSON(t *testing.T) {
	t.Parallel()
	const dqs = "\""
	var zero Output
	tests := []struct {
