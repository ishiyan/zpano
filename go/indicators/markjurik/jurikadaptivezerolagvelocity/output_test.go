...
func TestAdaptiveZeroLagVelocityOutputString(t *testing.T) {
	t.Parallel()
	tests := []struct {
		o    Output
		text string
...
func TestAdaptiveZeroLagVelocityOutputIsKnown(t *testing.T) {
	t.Parallel()
	tests := []struct {
		o       Output
		boolean bool
		...
		{Value, true},
		{adaptiveZeroLagVelocityLast, false},
		{Output(0), false},
		{Output(9999), false},
		{Output(-9999), false},
	}
...
func TestAdaptiveZeroLagVelocityOutputMarshalJSON(t *testing.T) {
	t.Parallel()
	const dqs = "\""
	var nilstr string
	tests := []struct {
...
func TestAdaptiveZeroLagVelocityOutputUnmarshalJSON(t *testing.T) {
	t.Parallel()
	const dqs = "\""
	var zero Output
	tests := []struct {
